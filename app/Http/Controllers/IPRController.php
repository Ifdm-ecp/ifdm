...
class IPRController extends Controller
{
     ...
     * Módulo cálculo IPR
     */
    public function krosg($saturacion_gas, $saturacion_aceite_irred, $saturacion_agua_irred, $saturacion_gas_crit,
              $saturacion_aceite_irred_gas, $end_point_kr_aceite_gas, $exponente_corey_aceite_gas)
    {
        $numerador = 1 - $saturacion_gas - $saturacion_aceite_irred_gas;  
    ...
    public function krg($saturacion_gas, $saturacion_gas_crit, $saturacion_aceite_irred_gas, $saturacion_agua_irred, $exponente_corey_gas, $end_point_kr_gas)
    {
       $numerador = $saturacion_gas - $saturacion_gas_crit;
    ...
    public function krosw($end_point_kr_petroleo, $sw, $saturacion_aceite_irred, $saturacion_agua_irred, $exponente_corey_petroleo)
    {
        $numerador = 1 - $sw - $saturacion_aceite_irred;
    ...
    public function krwsw($end_point_kr_agua, $sw, $saturacion_aceite_irred, $saturacion_agua_irred, $exponente_corey_agua)
    {
        $numerador = $sw - $saturacion_agua_irred;
        $denominador = 1 - $saturacion_agua_irred - $saturacion_aceite_irred;
        $krwsw = $end_point_kr_agua * (($numerador / $denominador) ** $exponente_corey_agua);
    ...
    public function flujo_fraccional($saturacion_agua_irred, $end_point_kr_petroleo, $end_point_kr_agua, $saturacion_aceite_irred, $exponente_corey_petroleo, $exponente_corey_agua, $presiones, $viscosidades_agua, $viscosidades_aceite, $pprom, $bsw, $campo_a1, $campo_b1, $campo_c1, $campo_d1, $campo_a2, $campo_b2, $campo_c2, $campo_d2, $lista_sw, $lista_krw, $lista_kro, $viscosidad_agua)
    {
        $sw = [];
        $kro = [];
        $krw = [];
        ...
        if (empty($viscosidades_aceite) or (count($viscosidades_aceite) == 1 and $viscosidades_aceite[0] == 0))
        {
            $uo = $this->cubica($campo_a1, $campo_b1, $campo_c1, $campo_d1, $pprom);
        }
        else
        {
        ...
        # Entra en el caso en que se usan ecuaciones cubicas y si no, cuando se usan tablas.
        if(empty($viscosidades_agua) or (count($viscosidades_agua) == 1 and $viscosidades_agua[0] == 0))
        {
          $uw = $viscosidad_agua;  
        } 
        else
        ...
        if(empty($lista_krw) or (count($lista_krw) == 1 and $lista_krw[0] == 0))
        {
           $j = 0;
           $i = $saturacion_agua_irred;

           while($i < (1 - $saturacion_aceite_irred))
           {
            array_push($sw,$i);
            array_push($kro, $this->krosw($end_point_kr_petroleo, $sw[$j], $saturacion_aceite_irred, $saturacion_agua_irred, $exponente_corey_petroleo));
            array_push($krw, $this->krwsw($end_point_kr_agua, $sw[$j], $saturacion_aceite_irred, $saturacion_agua_irred, $exponente_corey_agua));
            array_push($fw, $this->fw($kro[$j], $krw[$j], $uo, $uw));
            $i = $i + 0.01;
            $j = $j + 1;
           }  

           array_push($sw, 1 - $saturacion_aceite_irred);
           array_push($kro, $this->krosw($end_point_kr_petroleo, $sw[$j], $saturacion_aceite_irred, $saturacion_agua_irred, $exponente_corey_petroleo));
           array_push($krw, $this->krwsw($end_point_kr_agua, $sw[$j], $saturacion_aceite_irred, $saturacion_agua_irred, $exponente_corey_agua));
           array_push($fw, $this->fw($kro[$j], $krw[$j], $uo, $uw)); 
        }
    ...
    public function saturacion_agua($saturacion_agua_irred, $end_point_kr_petroleo, $end_point_kr_agua, $saturacion_aceite_irred, $exponente_corey_petroleo, $exponente_corey_agua, $presiones, $viscosidades_agua, $viscosidades_aceite, $pprom, $bsw, $campo_a1, $campo_b1, $campo_c1, $campo_d1, $campo_a2, $campo_b2, $campo_c2, $campo_d2, $lista_sw, $lista_krw, $lista_kro, $viscosidad_agua)
    {
        $result = $this->flujo_fraccional($saturacion_agua_irred, $end_point_kr_petroleo, $end_point_kr_agua, $saturacion_aceite_irred, $exponente_corey_petroleo, $exponente_corey_agua, $presiones, $viscosidades_agua, $viscosidades_aceite, $pprom, $bsw, $campo_a1, $campo_b1, $campo_c1,$campo_d1, $campo_a2, $campo_b2, $campo_c2, $campo_d2, $lista_sw, $lista_krw, $lista_kro, $viscosidad_agua);
        $fw = $result[0];
        $sw = $result[1];
    ...
    public function pseudopresion($z, $viscosidades_gas, $presiones_pvt, $presion_yacimiento, $a1, $b1, $c1, $d1, $a2, $b2, $c2, $d2)
    {
        ...
        {
            if(empty($viscosidades_gas) or (count($viscosidades_gas) == 1 and $viscosidades_gas[0] == 0))
            {
                $visco = $this->cubica($a1, $b1, $c1, $d1, $p);
            }
            else
            {
            ...
            if(empty($z) or (count($z) == 1 and $z[0] == 0))
            {
                $zeta = $this->cubica($a2, $b2, $c2, $d2, $p);
            }
            else
            {
    ...
    public function sumatoria($presiones, $integral, $presion_yacimiento, $presion_fondo)
    {
    ...
    public function skin_aceite($presion_burbuja, $presion_yacimiento, $presion_fondo, $tasa_aceite, $permeabilidad_abs_ini, $modulo_permeabilidad, $presion_inicial, $espesor_reservorio, $radio_drenaje_yac, $radio_pozo, $saturacion_agua_irred, $end_point_kr_petroleo, $end_point_kr_agua, $saturacion_aceite_irred, $exponente_corey_petroleo, $exponente_corey_agua, $end_point_kr_aceite_gas, $exponente_corey_aceite_gas, $saturacion_gas_crit, $saturacion_aceite_irred_gas, $lista_sw, $lista_krw, $lista_kro, $lista_sg, $lista_krg, $lista_krog,
                    $presiones_PVT, $viscosidades_agua, $viscosidades_aceite, $viscosidad_agua, $factores_vol_aceite, $bsw, $campo_a1, $campo_b1, $campo_c1, $campo_d1, $campo_a2, $campo_b2, $campo_c2, $campo_d2)
    {
        $skin = 0;
        ...
        if($presion_yacimiento > $presion_burbuja and $presion_fondo > $presion_burbuja)
        {
            ...
            $sw = $this->saturacion_agua($saturacion_agua_irred, $end_point_kr_petroleo, $end_point_kr_agua, $saturacion_aceite_irred, $exponente_corey_petroleo, $exponente_corey_agua, $presiones_PVT, $viscosidades_agua, $viscosidades_aceite, $presion_promedio, $bsw, $campo_a1, $campo_b1, $campo_c1, $campo_d1, $campo_a2, $campo_b2, $campo_c2, $campo_d2, $lista_sw, $lista_krw, $lista_kro, $viscosidad_agua);

            if(empty($lista_kro) or (count($lista_kro) == 1 and $lista_kro[0] == 0))
            {
                $krow = $this->krosw($end_point_kr_petroleo, $sw, $saturacion_aceite_irred, $saturacion_agua_irred, $exponente_corey_petroleo);
            }
            else
            {
            ...
            if(empty($lista_krog) or (count($lista_krog) == 1 and $lista_krog[0] == 0))
            {
                $krog = $this->krosg($sg, $saturacion_aceite_irred, $saturacion_agua_irred, $saturacion_gas_crit, $saturacion_aceite_irred_gas, $end_point_kr_aceite_gas, $exponente_corey_aceite_gas);
            }
            else
            {
            ...
            if(empty($viscosidades_aceite) or (count($viscosidades_aceite) == 1 and $viscosidades_aceite[0] == 0))
            {
                $uo = $this->cubica($campo_a1, $campo_b1, $campo_c1, $campo_d1, $presion_promedio);
            }
            else
            {
            ...
            if(empty($factores_vol_aceite) or (count($factores_vol_aceite) == 1 and $factores_vol_aceite[0] == 0))
            {
                $bo = $this->cubica($campo_a2, $campo_b2, $campo_c2, $campo_d2, $presion_promedio);
            }
            else
            {
        ...
        {
            $sw = $this->saturacion_agua($saturacion_agua_irred, $end_point_kr_petroleo, $end_point_kr_agua, $saturacion_aceite_irred, $exponente_corey_petroleo, $exponente_corey_agua, $presiones_PVT, $viscosidades_agua, $viscosidades_aceite, $presion_burbuja, $bsw, $campo_a1, $campo_b1, $campo_c1, $campo_d1, $campo_a2, $campo_b2,$campo_c2, $campo_d2, $lista_sw, $lista_krw, $lista_kro, $viscosidad_agua);
            ...
            if(empty($viscosidades_aceite) or (count($viscosidades_aceite) == 1 and $viscosidades_aceite[0] == 0))
            {
                $uo = $this->cubica($campo_a1, $campo_b1, $campo_c1, $campo_d1, $presion_burbuja);
            }
            else
            {
            ...
            if(empty($factores_vol_aceite) or (count($factores_vol_aceite) == 1 and $factores_vol_aceite[0] == 0))
            {
                $bo = $this->cubica($campo_a2, $campo_b2, $campo_c2, $campo_d2, $presion_burbuja);
            }
            else
            {
    ...
    public function ipr_aceite($presion_burbuja, $presion_yacimiento, $skin, $permeabilidad_abs_ini, $modulo_permeabilidad, $presion_inicial, $espesor_reservorio, $radio_drenaje_yac, $radio_pozo, $saturacion_agua_irred, $end_point_kr_petroleo, $end_point_kr_agua, $saturacion_aceite_irred, $exponente_corey_petroleo, $exponente_corey_agua, $end_point_kr_aceite_gas, $exponente_corey_aceite_gas, $saturacion_gas_crit, $saturacion_aceite_irred_gas, $lista_sw, $lista_krw, $lista_kro, $lista_sg, $lista_krg, $lista_krog, $presiones_pvt, $viscosidades_agua, $viscosidades_aceite, $viscosidad_agua, $factores_vol_aceite, $bsw, $campo_a1, $campo_b1, $campo_c1, $campo_d1, $campo_a2, $campo_b2, $campo_c2, $campo_d2)
    {
        $delta = $presion_yacimiento / 19;
        $presion_fondo_lista = [];
        $tasa_aceite_lista = [];
        ...
        if($presion_fondo < 0)
        {
            ...
            if ($presion_yacimiento > $presion_burbuja and $presion_fondo < $presion_burbuja)
            {
                ...
                if(empty($factores_vol_aceite) or (count($factores_vol_aceite) == 1 and $factores_vol_aceite[0] == 0))
                {
                    $bo = cubica($campo_a2, $campo_b2, $campo_c2, $campo_d2, $presion_burbuja);
                }
                else
                {
                    $bo = $this->interpolador($presiones_pvt, $factores_vol_aceite, $presion_burbuja);
    ...
    public function skin_gas($permeabilidad_abs_ini, $modulo_permeabilidad, $presion_fondo, $presion_yacimiento, $presion_inicial, $tasa_gas, $presiones_pvt, $viscosidades_gas, $z, $t, $espesor_reservorio, $radio_drenaje_yac, $radio_pozo, $a1, $b1, $c1, $d1, $a2, $b2, $c2, $d2)
    {
        $permeabilidad_absoluta = $this->kabs($permeabilidad_abs_ini, $modulo_permeabilidad, $presion_yacimiento, $presion_inicial);
        $pseudopresion_result = $this->pseudopresion($z, $viscosidades_gas, $presiones_pvt, $presion_yacimiento, $a1, $b1, $c1, $d1, $a2, $b2, $c2, $d2);
    ...
    public function ipr_gas($permeabilidad_abs_ini, $modulo_permeabilidad, $presion_yacimiento, $presion_inicial, $z, $t, $radio_drenaje_yac, $radio_pozo, $skin, $presiones_pvt, $viscosidades_gas, $espesor_reservorio, $a1, $b1, $c1, $d1, $a2, $b2, $c2, $d2)
    {
        $permeabilidad_absoluta = $this->kabs($permeabilidad_abs_ini, $modulo_permeabilidad, $presion_yacimiento, $presion_inicial);
        $presion_fondo = $presion_yacimiento;
    ...
    public function skin_gas_condensado($permeabilidad_abs_ini, $modulo_permeabilidad, $presion_yacimiento, $presion_inicial, $net_pay, $radio_drenaje_yac, $radio_pozo, $lista_bo, $lista_bg, $lista_uo,  $lista_ug, $gor, $lista_presiones, $lista_ogr, $lista_presiones_so, $lista_so, $presion_fondo, $caudal_gas, $presion_rocio, $lista_rs, $lista_sg, $lista_krg, $lista_kro)
    {
        $ogr = 1 / $gor;
    ...
    public function ipr_gas_condensado($permeabilidad_abs_ini, $modulo_permeabilidad, $presion_yacimiento, $presion_inicial, $radio_drenaje_yac, $radio_pozo, $skin, $espesor_reservorio, $presion_rocio, $gor, $lista_presiones, $lista_ogr, $lista_bo, $lista_bg, $lista_uo, $lista_ug, $lista_rs, $lista_sg, $lista_krg, $lista_kro, $lista_presiones_so, $lista_so)
    {
        $ogr = 1 / $gor;
    ...
    public function retornogascondensado($fluid, $well_radius, $drainage_radius, $reservoir_pressure, $gas_rate_c_g, $bhp_c_g, $initial_pressure_c_g, $ini_abs_permeability_c_g, $netpay_c_g, $permeability_module_c_g, $permeability_c_g, $porosity_c_g, $rock_type_c_g, $saturation_pressure_c_g, $gor_c_g, $sg_data, $krg_data, $krog_data, $pressure_data, $bo_data, $vo_data, $rs_data, $bg_data, $vg_data, $og_ratio_data, $dropout_pressure_data, $dropout_liquid_percentage, $skin)
    {
        if($skin != 0)
        {
            $skin = $this->skin_gas_condensado($ini_abs_permeability_c_g, $permeability_module_c_g, $reservoir_pressure, $initial_pressure_c_g, $netpay_c_g, $drainage_radius, $well_radius, $bo_data, $bg_data, $vo_data, $vg_data, $gor_c_g, $pressure_data, $og_ratio_data, $dropout_pressure_data, $dropout_liquid_percentage, $bhp_c_g, $gas_rate_c_g, $saturation_pressure_c_g, $rs_data, $sg_data, $krg_data, $krog_data);
        }

        $ipr_data = $this->ipr_gas_condensado($ini_abs_permeability_c_g, $permeability_module_c_g, $reservoir_pressure, $initial_pressure_c_g, $drainage_radius, $well_radius, $skin, $netpay_c_g, $saturation_pressure_c_g, $gor_c_g, $pressure_data, $og_ratio_data, $bo_data, $bg_data, $vo_data, $vg_data, $rs_data, $sg_data, $krg_data, $krog_data, $dropout_pressure_data, $dropout_liquid_percentage);
