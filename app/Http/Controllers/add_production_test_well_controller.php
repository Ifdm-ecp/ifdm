...
class add_production_test_well_controller extends Controller
{
    /**
     * Despliega la vista add_production_Test_well con la información de los pozos para popular los select y consultar la información de los intervalos productores.
     *
