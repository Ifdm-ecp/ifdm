...
class MultiparametricStatisticalRequest extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'ms_scale_index_caco3.numeric' => 'Scale index of CaCO3 weight must be numeric.',
            'ms_scale_index_baso4.numeric' => 'Scale index of BaSO4 weight must be numeric.',
            'ms_scale_index_iron_scales.numeric' => 'Scale index of iron scales weight must be numeric.',
            'ms_calcium_concentration.numeric' => 'Backflow [Ca] weight must be numeric.',
            'ms_barium_concentration.numeric' => 'Backflow [Ba] weight must be numeric.',

            'fb_aluminum_concentration.numeric' => '[Al] on Produced Water weight must be numeric.',
            'fb_silicon_concentration.numeric' => '[Si] on produced water weight must be numeric.',
            'fb_critical_radius_factor.numeric' => 'Critical Radius derived from maximum critical velocity, Vc weight must be numeric.',
            'fb_mineralogic_factor.numeric' => 'Mineralogy Factor weight must be numeric.',
            ...
            'rp_days_below_saturation_pressure.numeric' => 'Number Of Days Below Saturation Pressure weight must be numeric.',
            'rp_delta_pressure_saturation.numeric' => 'Difference between current reservoir pressure and saturation pressure weight must be numeric.',
            'rp_water_intrusion.numeric' => 'Cumulative Water Produced weight must be numeric.',
            'rp_high_impact_factor.numeric' => 'Pore Size Diameter Approximation By Katz And Thompson Correlation (d = 1/√(ϕ * k)) weight must be numeric.',
            'rp_velocity_estimated.numeric' => 'Velocity parameter estimated from maximum critical velocity weight must be numeric.',

            'id_gross_pay.numeric' => 'Gross Pay weight must be numeric.',
            'id_polymer_damage_factor.numeric' => 'Total polymer pumped during Hydraulic Fracturing weight must be numeric.',
