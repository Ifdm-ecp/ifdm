...
class asphaltene_diagnosis_request extends Request
{
    ...
    public function rules()
    {
        ...
        if (!$button_wr) {
            return [
                ...
                'compressibility'=> 'numeric|required|between:0,100|not_in:0',
    ...
    public function messages()
    {
        return [
            ...
            'compressibility.between' => 'Compressibility must be between 0 and 100 (not including 0).',
            'compressibility.not_in' => 'Compressibility must be between 0 and 100 (not including 0).',
