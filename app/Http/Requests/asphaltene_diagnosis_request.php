...
class asphaltene_diagnosis_request extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'current_pressure.required' => 'Current pressure required.',
            ...
            'current_pressure.numeric' => 'Current pressure must be numeric.',
            ...
            'current_pressure.between' => 'Current pressure must be between 0 and 100000 (not including 0).',
            'current_pressure.not_in' => 'Current pressure must be between 0 and 100000 (not including 0).',
            'initial_pressure.between' => 'Initial pressure must be between 0 and 100000 (not including 0).',
            'initial_pressure.not_in' => 'Initial pressure must be between 0 and 100000 (not including 0).',
