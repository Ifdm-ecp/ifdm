...
class fines_migration_diagnosis_request extends Request
{
    ...
    public function rules()
    {
        ...
        if (!isset($_POST['button_wr'])) {
            return [
                ...
                'perforation_radius'=> 'numeric|required_with:number_of_perforations|min:0',
                'number_of_perforations'=> 'numeric|required_with:perforation_radius|min:0',
    ...
    public function messages()
    {
        return [
            ...
            'number_of_perforations.required_with'=> 'Number of perforations is required if Perforation radius is set.',
