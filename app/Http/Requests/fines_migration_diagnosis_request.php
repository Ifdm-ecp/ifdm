...
class fines_migration_diagnosis_request extends Request
{
    ...
    public function rules()
    {
        ...
        if (!isset($_POST['button_wr'])) {
            return [
                ...
                'perforation_radius'=> 'numeric|required|min:0',
                'number_of_perforations'=> 'numeric|required|min:0',
                'compressibility'=> 'numeric|required|between:0,1|not_in:0',
                'initial_porosity'=> 'numeric|required|between:0,1|not_in:0,1',
                'porosity_limit_constant'=> 'numeric|required|between:0,1|not_in:0,1',
                ...
                'initial_saturation' => 'numeric|required|between:0,1|not_in:0,1',
    ...
    public function messages()
    {
        return [
            ...
            'perforation_radius.required'=> 'Perforation radius required.',
            'number_of_perforations.required'=> 'Numbers of perforations required.',
            'compressibility.required'=> 'Compressibility required.',
            'initial_porosity.required'=> 'Initial porosity required.',
            'porosity_limit_constant.required'=> 'Constant for porosity limit is required.',
            ...
            'initial_saturation.required' => 'Initial saturation required.',
            ...
            'number_of_perforations.numeric'=> 'Numbers of perforations must be numeric.',
            'compressibility.numeric'=> 'Compressibility must be numeric.',
            'initial_porosity.numeric'=> 'Initial porosity must be numeric.',
            'porosity_limit_constant.numeric'=> 'The constant for porosity limit must be numeric.',
            ...
            'initial_saturation.numeric' => 'Initial saturation must be numeric.',
            ...
            'initial_saturation.between' => 'Initial Saturation must be between 0 and 1 (0>value>1).',
            'initial_saturation.not_in' => 'Initial Saturation must be between 0 and 1 (0>value>1).',
            'compressibility.between' => 'Compressibility must be between 0 and 1.',
            'compressibility.not_in' => 'Compressibility must be between 0 and 1.',
            'porosity_limit_constant.between' => 'Constant for the porosity limit must be between 0 and 1 (0>value>1).',
            'porosity_limit_constant.not_in' => 'Constant for the porosity limit must be between 0 and 1 (0>value>1).',
