...
class fines_migration_diagnosis_request extends Request
{
    ...
    public function rules()
    {
        ...
        if (!isset($_POST['button_wr'])) {
            return [
                ...
                'water_volumetric_factor' => 'numeric|between:0,1',
                'plug_radius' => 'numeric|between:0,2',
    ...
    public function messages()
    {
        return [
            ...
            'water_volumetric_factor.between' => 'Water volumetric must be between 0 and 1.',
            'plug_radius.between' => 'Plug radius must be between 0 and 2.',
