...
<div id="sticky">
   <center>
      {!! Form::label('Scenario: ') !!} {!! $scenary_s->nombre !!} {!! Form::label(' - Basin: ') !!} {!! $_SESSION['basin'] !!} {!! Form::label(' - Field: ') !!} {!! $_SESSION['field'] !!} {!! Form::label(' - Producing interval: ') !!} {!!  $intervalo->nombre !!} {!! Form::label(' - Well: ') !!} {!!  $_SESSION['well'] !!} {!! Form::label(' - User: ') !!} {!! $user->fullName !!}
   </center>
</div>
<p></p>
</br>
      ...
      <div class="tab-content">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('radio_pozo') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('radio_pozo',$pozo->radius, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'radio_pozo']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('radio_drenaje_yac') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('radio_drenaje_yac',$pozo->drainage_radius, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'radio_drenaje_yac']) !!}
                                 <span class="input-group-addon" id="basic-addon2">ft</span>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('presion_yacimiento') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('presion_yacimiento',$formacion->presion_reservorio, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_yacimiento']) !!}
         ...
         <div class="tab-pane " id="production_data_c">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group {{$errors->has('tasa_flujo') ? 'has-error' : ''}}">
                                       ...
                                       @endif
                                       {!! Form::text('tasa_flujo',null, ['placeholder' => 'bbl/day', 'class' =>'form-control', 'id' => 'tasa_flujo']) !!}
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group {{$errors->has('presion_fondo') ? 'has-error' : ''}}">
                                       ...
                                       @endif
                                       {!! Form::text('presion_fondo',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_fondo']) !!}
                                       <span class="input-group-addon" id="basic-addon2">psi</span>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('bsw') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('bsw',null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'bsw']) !!}
                           ...
                           <div class="col-md-6" style="display:none;">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('gor') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('gor',null, ['placeholder' => 'SCF/STB', 'class' =>'form-control', 'id' => 'gor']) !!}
            ...
            <div class="gas_data" style="display:none;">           
                  <div class="panel panel-default">
                     <div class="panel-heading">
                        <h4><a data-parent="#accordion" data-toggle="collapse" href="#production_data_panel_g"><span class="chevron_toggleable glyphicon glyphicon-chevron-down pull-right"></span></a> Production Data </h4>
                     </div>
                     <div class="panel-body">
                        <div class="panel-collapse collapse in" id="production_data_panel_g">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group {{$errors->has('gas_rate_g') ? 'has-error' : ''}}">
                                       ...
                                       @endif
                                       {!! Form::text('gas_rate_g',null, ['placeholder' => 'MMscf/day', 'class' =>'form-control', 'id' => 'gas_rate_g']) !!}
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group {{$errors->has('bhp_g') ? 'has-error' : ''}}">
                                       ...
                                       @endif
                                       {!! Form::text('bhp_g',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'bhp_g']) !!}
                                       <span class="input-group-addon" id="basic-addon2">psi</span>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('gas_rate_c_g') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('gas_rate_c_g',null, ['placeholder' => 'MMscf/day', 'class' =>'form-control', 'id' => 'gas_rate_c_g']) !!}
                                    <span class="input-group-addon" id="basic-addon2">MMscf/day</span>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('bhp_c_g') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('bhp_c_g',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'bhp_c_g']) !!}
                                    <span class="input-group-addon" id="basic-addon2">psi</span>
                                 </div>
                              </div>
                           </div>
         ...
         <div class="tab-pane " id="rock_properties_c">
                           ...
                           <div class="panel-body">
                              <div id="BasicP" class="panel-collapse collapse in">
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          {!! Form::label('stress_sensitive_reservoir_oil', 'Stress sensitive reservoir ') !!}<span style='color:red;'>*</span>
                                          <div class="input-group {{$errors->has('fluido') ? 'has-error' : ''}}">
                                             <select name="stress_sensitive_reservoir_oil" onchange="defineRockProps(this,'oil')" class="form-control" id="stress_sensitive_reservoir_oil">
                                    ...
                                    <div class="col-md-6 p_inicial_oil">
                                       <div class="form-group">
                                          ...
                                          <div class="input-group {{$errors->has('presion_inicial') ? 'has-error' : ''}}">
                                             ...
                                             @endif
                                             {!! Form::text('presion_inicial',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_inicial']) !!}
                                             <span class="input-group-addon" id="basic-addon2">psi</span>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6 p_absoluta_oil" style="display: none;">
                                       <div class="form-group">
                                          {!! Form::label('permeabilidad_label', 'Absolute Permeability ') !!}<span style='color:red;'>*</span>
                                    ...
                                    <div class="col-md-6 p_a_inicial_oil">
                                       <div class="form-group">
                                          ...
                                          <div class="input-group {{$errors->has('permeabilidad_abs_ini') ? 'has-error' : ''}}">
                                             ...
                                             @endif
                                             {!! Form::text('permeabilidad_abs_ini',null, ['placeholder' => 'md', 'class' =>'form-control', 'id' => 'permeabilidad_abs_ini']) !!}
                                             <span class="input-group-addon" id="basic-addon2">md</span>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-group {{$errors->has('espesor_reservorio') ? 'has-error' : ''}}">
                                             ...
                                             @endif
                                             {!! Form::text('espesor_reservorio',null, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'espesor_reservorio']) !!}
                                             <span class="input-group-addon" id="basic-addon2">ft</span>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <fieldset class="u_p_module_oil">
                                    <legend>
                                       {!! Form::radio('check_use_permeability_module_o', 'check_use_permeability_module_o', true, ["id" => "check_use_permeability_module_o"]) !!}
                                       <font size=3><b>Use Permeability Module</b></font>
                                    </legend>
                                    <div class="check_use_permeability_o" style="display:none;">
                                       <div class="col-md-10 use_permeability_module">
                                          <div class="col-md-10">
                                             <div class="form-group">
                                                ...
                                                <div class="input-group {{$errors->has('modulo_permeabilidad') ? 'has-error' : ''}}">
                                                      ...
                                                      <span class="input-group-btn">
                                                         ...
                                                         @endif
                                                   {!! Form::text('modulo_permeabilidad',null, ['placeholder' => '1/psi', 'class' =>'form-control', 'id' => 'modulo_permeabilidad']) !!}
                                                   <span class="input-group-addon" id="basic-addon2">psi<sup>-1</sup></span>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="col-md-2">
                                             <button type="button" class="btn btn-primary b_calculate btn_calculate_oil" style="margin-top: 22px;">Calculate by Correlation</button>
                                          </div>
                                       </div>
                                    </div>
                                 </fieldset>
                                 <fieldset class="c_p_module_oil">
                                    <legend>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <div class="input-group {{$errors->has('porosidad') ? 'has-error' : ''}}">
                                                   ...
                                                   @endif
                                                   {!! Form::text('porosidad',$formacion->porosidad, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'porosidad']) !!}
                                                   <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                </div>
                                             </div>
                                          </div>
                        ...
                        <div class="panel panel-default">
                           ...
                           <div class="panel-body">
                              <div id="Permeability_Relative" class="panel-collapse collapse in">
                                 ...
                                 <fieldset>
                                    <legend>
                                       {!! Form::radio('check_tabular_rel_perm_o', 'check_tabular_rel_perm_o', true, ["id" => "check_tabular_rel_perm_o"]) !!}
                                             ...
                                             <div id="Kro" class="panel-collapse collapse in">
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="input-group {{$errors->has('end_point_kr_aceite_gas') ? 'has-error' : ''}}">
                                                      ...
                                                      @endif
                                                      {!! Form::text('end_point_kr_aceite_gas', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'end_point_kr_aceite_gas']) !!}
                                                      <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="input-group {{$errors->has('saturacion_gas_crit') ? 'has-error' : ''}}">
                                                      ...
                                                      @endif
                                                      {!! Form::text('saturacion_gas_crit', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'saturacion_gas_crit']) !!}
                                                      <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div class="input-group {{$errors->has('end_point_kr_gas') ? 'has-error' : ''}}">
                                                         ...
                                                         @endif
                                                         {!! Form::text('end_point_kr_gas', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'end_point_kr_gas']) !!}
                                                         <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div class="input-group {{$errors->has('saturacion_aceite_irred_gas') ? 'has-error' : ''}}">
                                                         ...
                                                         @endif
                                                         {!! Form::text('saturacion_aceite_irred_gas', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'saturacion_aceite_irred_gas']) !!}
                                                         <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                      </div>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div class="input-group {{$errors->has('exponente_corey_aceite_gas') ? 'has-error' : ''}}">
                                                         ...
                                                         @endif
                                                         {!! Form::text('exponente_corey_aceite_gas',null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'exponente_corey_aceite_gas']) !!}
                                                         <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="input-group {{$errors->has('exponente_corey_gas') ? 'has-error' : ''}}">
                                                      ...
                                                      @endif
                                                      {!! Form::text('exponente_corey_gas', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'exponente_corey_gas']) !!}
                                                      <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                   </div>
                                                </div>
                                                </div>
                                             ...
                                             <div id="Krw" class="panel-collapse collapse in">
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="input-group {{$errors->has('end_point_kr_petroleo') ? 'has-error' : ''}}">
                                                      ...
                                                      @endif
                                                      {!! Form::text('end_point_kr_petroleo', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'end_point_kr_petroleo']) !!}
                                                      <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                   </div>
                                                </div>
                                                   <div class="col-md-6">
                                                      <div class="form-group">
                                                         ...
                                                         <div class="input-group {{$errors->has('saturacion_agua_irred') ? 'has-error' : ''}}">
                                                            @if($advisor === "true")
                                                               <span class="input-group-btn">
                                                                  <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                               </span>
                                                            @endif
                                                            {!! Form::text('saturacion_agua_irred', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'saturacion_agua_irred']) !!} 
                                                            <span class="input-group-addon" id="basic-addon2">Fraction</span> 
                                                         </div>
                                                      </div>
                                                   </div>
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div class="input-group {{$errors->has('end_point_kr_agua') ? 'has-error' : ''}}">
                                                         ...
                                                         @endif
                                                         {!! Form::text('end_point_kr_agua', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'end_point_kr_agua']) !!}
                                                         <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div class="input-group {{$errors->has('saturacion_aceite_irred') ? 'has-error' : ''}}">
                                                         ...
                                                         @endif
                                                         {!! Form::text('saturacion_aceite_irred', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'saturacion_aceite_irred']) !!}
                                                         <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                      </div>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div class="input-group {{$errors->has('exponente_corey_petroleo') ? 'has-error' : ''}}">
                                                         @if($advisor === "true")
                                                            <span class="input-group-btn">
                                                               <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                            </span>
                                                         @endif
                                                         {!! Form::text('exponente_corey_petroleo', null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'exponente_corey_petroleo']) !!}
                                                         <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="input-group {{$errors->has('exponente_corey_agua') ? 'has-error' : ''}}">
                                                      ...
                                                      @endif
                                                      {!! Form::text('exponente_corey_agua',null, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'exponente_corey_agua']) !!}
                                                      <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                   </div>
                                                </div>
                                                </div>
            ...
            <div class="gas_data" style="display:none">
                          ...
                          <div class="panel panel-default">
                             <div class="panel-heading">
                                <h4><a data-parent="#accordion" data-toggle="collapse" href="#rock_properties_panel_g"><span class="chevron_toggleable glyphicon glyphicon-chevron-down pull-right"></span></a> Rock Properties </h4>
                             </div>
                             <div class="panel-body">
                                <div id="rock_properties_panel_g" class="panel-collapse collapse in">
                                   <br>
                                   <div class="panel panel-default">
                                      <div class="panel-heading">
                                      ...
                                      <div class="panel-body">
                                         <div id="basic_petrophysics_g" class="panel-collapse collapse in">
                                            <div class="row">
                                                <div class="col-md-12">
                                                   <div class="form-group">
                                                      {!! Form::label('stress_sensitive_reservoir_gas', 'Stress sensitive reservoir ') !!}<span style='color:red;'>*</span>
                                                      <div class="input-group {{$errors->has('fluido') ? 'has-error' : ''}}">
                                                         <select name="stress_sensitive_reservoir_gas" onchange="defineRockProps(this,'gas')" class="form-control" id="stress_sensitive_reservoir_gas">
                                                            <option value="yes" selected>Yes</option>
                                                            <option value="no">No</option>
                                                         </select>
                                                      </div>
                                               ...
                                               <div class="col-md-6 p_inicial_gas">
                                                  <div class="form-group">
                                                     {!! Form::label('init_res_press_text_g', ' Initial Reservoir Pressure ') !!}<span style='color:red;'>*</span>
                                                     <div class="input-group {{$errors->has('init_res_press_text_g') ? 'has-error' : ''}}">
                                                        @if($advisor === "true")
                                                            <span class="input-group-btn">
                                                               <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                            </span>
                                                         @endif
                                                        {!! Form::text('init_res_press_text_g',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'init_res_press_text_g']) !!}
                                                        <span class="input-group-addon" id="basic-addon2">psi</span>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="col-md-6 p_a_inicial_gas">
                                                  <div class="form-group">
                                                     {!! Form::label('abs_perm_init_label_g', 'Absolute Permeability At Initial Reservoir Pressure ') !!}<span style='color:red;'>*</span>
                                                     <div class="input-group {{$errors->has('abs_perm_init_text_g') ? 'has-error' : ''}}">
                                                        @if($advisor === "true")
                                                            <span class="input-group-btn">
                                                               <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                            </span>
                                                         @endif
                                                        {!! Form::text('abs_perm_init_text_g',null, ['placeholder' => 'md', 'class' =>'form-control', 'id' => 'abs_perm_init_text_g']) !!}
                                                        <span class="input-group-addon" id="basic-addon2">md</span>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="col-md-6">
                                                  <div class="form-group">
                                                     ...
                                                     <div class="input-group {{$errors->has('net_pay_text_g') ? 'has-error' : ''}}">
                                                        @if($advisor === "true")
                                                            <span class="input-group-btn">
                                                               <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                            </span>
                                                         @endif
                                                        {!! Form::text('net_pay_text_g',null, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'net_pay_text_g']) !!}
                                                        <span class="input-group-addon" id="basic-addon2">ft</span>
                                                     </div>
                                                  </div>
                                               </div>

                                               <div class="col-md-6 p_absoluta_gas" style="display: none;">
                                                   <div class="form-group">
                                                      {!! Form::label('permeabilidad_label', 'Absolute Permeability ') !!}<span style='color:red;'>*</span>
                                                      <div class="input-group {{$errors->has('permeabilidad') ? 'has-error' : ''}}">
                                                         @if($advisor === "true")
                                            ...
                                            <fieldset class="u_p_module_gas">
                                               <legend>
                                                  {!! Form::radio('check_permeability_module_g', 'check_use_permeability_module_g', true, ["id" => "check_use_permeability_module_g"]) !!}
                                                  <font size=3><b>Use Permeability Module</b></font>
                                               </legend>
                                               <div class="check_use_permeability_g" style="display:none";>
                                                  <div class="row">
                                                     <div class="col-md-10 use_permeability_module_g">
                                                        <div class="col-md-10">
                                                           <div class="form-group">
                                                              {!! Form::label('permeability_module_label_g', 'Permeability Module') !!} <span style='color:red;'>*</span>
                                                              <div class="input-group {{$errors->has('permeability_module_text_g') ? 'has-error' : ''}}">
                                                                  @if($advisor === "true")
                                                                     <span class="input-group-btn">
                                                                        <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                                     </span>
                                                                  @endif
                                                                 {!! Form::text('permeability_module_text_g',null, ['placeholder' => '1/psi', 'class' =>'form-control', 'id' => 'permeability_module_text_g']) !!}
                                                                 <span class="input-group-addon" id="basic-addon2">psi<sup>-1</sup></span>
                                                              </div>
                                                           </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <button type="button" class="btn btn-primary b_calculate btn_calculate_gas" style="margin-top: 22px;">Calculate by Correlation</button>
                                                         </div>
                                                     </div>
                                                  </div>
                                               </div>
                                            ...
                                            <fieldset class="u_p_module_gas">
                                               <legend>
                                                  {!! Form::radio('check_permeability_module_calculated_g', 'check_calculate_permeability_module_g', false, ["id" => "check_calculate_permeability_module_g"]) !!}
                                               ...
                                               <div class="check_calculate_permeability_g" style="display:none;">
                                                  <div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                           ...
                                                           <div class="input-group {{$errors->has('abs_perm_text_g') ? 'has-error' : ''}}">
                                                               @if($advisor === "true")
                                                                  <span class="input-group-btn">
                                                                     <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                                  </span>
                                                               @endif
                                                              {!! Form::text('abs_perm_text_g',$formacion->permeabilidad, ['placeholder' => 'md', 'class' =>'form-control', 'id' => 'abs_perm_text_g']) !!}
                                                              <span class="input-group-addon" id="basic-addon2">md</span>
                                                           </div>
                                                        </div>
                                                     </div>
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                           ...
                                                           <div class="input-group {{$errors->has('porosity_text_g') ? 'has-error' : ''}}">
                                                               @if($advisor === "true")
                                                                  <span class="input-group-btn">
                                                                     <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                                                  </span>
                                                               @endif
                                                              {!! Form::text('porosity_text_g',$formacion->porosidad, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'porosity_text_g']) !!}
                                                              <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                                           </div>
                                                        </div>
                                                     </div>
                                                  ...
                                                  <div class="row">
                                                     <div class="col-md-6 calculate_permeability_module_g">
                                                        <div class="form-group">
                                                           {!! Form::label('rock_type_g', 'Rock Type') !!} <span style='color:red;'>*</span>
                                                           <select name="rock_type" class="form-control" id="rock_type">
                                                              <option value="0"></option>
                                                              @if(session('tipo_roca') == '1')
                                                              <option value="1" selected>Consolidated</option>
                                                              @else
                                                              <option value="1">Consolidated</option>
                                                              @endif
                                                              @if(session('tipo_roca') == '2')
                                                              <option value="2" selected>Unconsolidated</option>
                                                              @else
                                                              <option value="2" >Unconsolidated</option>
                                                              @endif
                                                              @if(session('tipo_roca')=='3')
                                                              <option value="3" selected>Microfractured</option>
                                                              @else
                                                              <option value="3">Microfractured</option>
                                                              @endif
                                   ...
                                   <div class="panel panel-default" style="display:none;">
                                      <div class="panel-heading">
                                         <h4><a data-parent="#accordion" data-toggle="collapse" href="#Permeability_Relative_g"><span class="chevron_toggleable1 glyphicon glyphicon-chevron-down pull-right"></span></a> Relative Permeability Data Selection</h4>
                                      </div>
                                      <div class="panel-body">
                                         <div id="Permeability_Relative_g" class="panel-collapse collapse in">
                                            <div class="row">
                                               <div class="col-md-6">
                                                  <div class="form-group">
                                                     <input type='hidden' id='basin' name='basin' value="{!!$_SESSION['basin']!!}">
                                            ...
                                            <fieldset>
                                               <legend>
                                                  {!! Form::radio('check_relative_permeability_g', 'check_tabular_rel_perm_g', false, ["id" => "check_tabular_rel_perm_g"]) !!}
                                                  <font size=3><b>Tabular</b></font>
                                               </legend>
                                               <div class="use_permeability_tables_g" style="display:none;">
                                                  <div class="row">
                                                     <div class="col-md-6" id="row_gasoil">
                                                        <fieldset>
                                                           <legend id="legend_gasoil">Gas-Oil</legend>
                                                     ...
                                                     <div class="panel-body">
                                                        <div id="Kro" class="panel-collapse collapse in">
                                                           ...
                                                           <div class="col-md-6">
                                                              {!! Form::label('end_point_kr_aceite_gas', 'Kro (Sgc)') !!}<span style='color:red;'>*</span>
                                                              <div class="input-group {{$errors->has('end_point_kr_aceite_gas') ? 'has-error' : ''}}">
                                                                 {!! Form::text('end_point_kr_aceite_gas_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'end_point_kr_aceite_gas_g']) !!}
                                                           ...
                                                           <div class="col-md-6">
                                                              {!! Form::label('saturacion_gas_crit', 'Sgc') !!}<span style='color:red;'>*</span>
                                                              <div class="input-group {{$errors->has('saturacion_gas_crit') ? 'has-error' : ''}}">
                                                                 {!! Form::text('saturacion_gas_crit_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'saturacion_gas_crit_g']) !!}
                                                                 <span class="input-group-addon" id="basic-addon2">-</span>
                                                              </div>
                                                           </div>
                                                           ...
                                                           <div class="col-md-6">
                                                              <div class="form-group">
                                                                 {!! Form::label('end_point_kr_gas', 'Krg (Sorg)') !!}<span style='color:red;'>*</span>
                                                                 <div class="input-group {{$errors->has('end_point_kr_gas') ? 'has-error' : ''}}">
                                                                    {!! Form::text('end_point_kr_gas_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'end_point_kr_gas_g']) !!}
                                                                    <span class="input-group-addon" id="basic-addon2">-</span>
                                                                 </div>
                                                              </div>
                                                           </div>
                                                           <div class="col-md-6">
                                                              <div class="form-group">
                                                                 {!! Form::label('saturacion_aceite_irred_gas', 'Sorg') !!}<span style='color:red;'>*</span>
                                                                 <div class="input-group {{$errors->has('saturacion_aceite_irred_gas') ? 'has-error' : ''}}">
                                                                    {!! Form::text('saturacion_aceite_irred_gas_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'saturacion_aceite_irred_gas_g']) !!}
                                                                    <span class="input-group-addon" id="basic-addon2">-</span>
                                                                 </div>
                                                              </div>
                                                           </div>
                                                           ...
                                                           <div class="col-md-6">
                                                              <div class="form-group">
                                                                 {!! Form::label('exponente_corey_aceite_gas', 'Corey Exponent Oil/Gas') !!}<span style='color:red;'>*</span>
                                                                 <div class="input-group {{$errors->has('exponente_corey_aceite_gas') ? 'has-error' : ''}}">
                                                                    {!! Form::text('exponente_corey_aceite_gas_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'exponente_corey_aceite_gas_g']) !!}
                                                                    <span class="input-group-addon" id="basic-addon2">-</span>
                                                                 </div>
                                                              </div>
                                                           </div>
                                                           <div class="col-md-6">
                                                              {!! Form::label('exponente_corey_gas', 'Corey Exponent Gas') !!}<span style='color:red;'>*</span>
                                                              <div class="input-group {{$errors->has('exponente_corey_gas') ? 'has-error' : ''}}">
                                                                 {!! Form::text('exponente_corey_gas_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'exponente_corey_gas_g']) !!}
                                                                 <span class="input-group-addon" id="basic-addon2">-</span>
                                                              </div>
                                                           </div>
                                                           </div>
                                                     ...
                                                     <div class="panel-body">
                                                        <div id="Krw" class="panel-collapse collapse in">
                                                           ...
                                                           <div class="col-md-6">
                                                              ...
                                                              <div class="input-group {{$errors->has('end_point_kr_petroleo') ? 'has-error' : ''}}">
                                                                 {!! Form::text('end_point_kr_petroleo_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'end_point_kr_petroleo_g']) !!}
                                                                 <span class="input-group-addon" id="basic-addon2">-</span>
                                                              </div>
                                                           </div>
                                                              <div class="col-md-6">
                                                                 <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                       {!! Form::text('saturacion_agua_irred_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'saturacion_agua_irred_g']) !!} 
                                                                       <span class="input-group-addon" id="basic-addon2">-</span> 
                                                                    </div>
                                                                 </div>
                                                              </div>
                                                           ...
                                                           <div class="col-md-6">
                                                              <div class="form-group">
                                                                 ...
                                                                 <div class="input-group {{$errors->has('Kro End Point ') ? 'has-error' : ''}}">
                                                                    {!! Form::text('end_point_kr_agua_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'end_point_kr_agua_g']) !!}
                                                                    <span class="input-group-addon" id="basic-addon2">-</span>
                                                                 </div>
                                                              </div>
                                                           </div>
                                                           <div class="col-md-6">
                                                              <div class="form-group">
                                                                 ...
                                                                 <div class="input-group {{$errors->has('Irreducible Oil Residual') ? 'has-error' : ''}}">
                                                                    {!! Form::text('saturacion_aceite_irred_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'saturacion_aceite_irred_g']) !!}
                                                                    <span class="input-group-addon" id="basic-addon2">-</span>
                                                                 </div>
                                                              </div>
                                                           </div>
                                                           ...
                                                           <div class="col-md-6">
                                                              <div class="form-group">
                                                                 ...
                                                                 <div class="input-group {{$errors->has('Corey Exponent ') ? 'has-error' : ''}}">
                                                                    {!! Form::text('exponente_corey_petroleo_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'exponente_corey_petroleo_g']) !!}
                                                                    <span class="input-group-addon" id="basic-addon2">-</span>
                                                                 </div>
                                                              </div>
                                                           </div>
                                                           <div class="col-md-6">
                                                              {!! Form::label('exponente_corey_agua', 'Corey Exponent Water') !!}<span style='color:red;'>*</span>
                                                              <div class="input-group {{$errors->has('exponente_corey_agua') ? 'has-error' : ''}}">
                                                                 {!! Form::text('exponente_corey_agua_g',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'exponente_corey_agua_g']) !!}
                                                                 <span class="input-group-addon" id="basic-addon2">-</span>
                                                              </div>
                                                           </div>
                                                           </div>
                  ...
                  <div class="panel-body">
                     <div id="BasicP_c_g" class="panel-collapse collapse in">
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 {!! Form::label('stress_sensitive_reservoir_condensate_gas', 'Stress sensitive reservoir ') !!}<span style='color:red;'>*</span>
                                 <div class="input-group {{$errors->has('fluido') ? 'has-error' : ''}}">
                                    <select name="stress_sensitive_reservoir_condensate_gas" onchange="defineRockProps(this,'condensate_gas')" class="form-control" id="stress_sensitive_reservoir_condensate_gas">
                                       <option value="yes" selected>Yes</option>
                                       <option value="no">No</option>
                                    </select>
                                 </div>
                           ...
                           <div class="col-md-6 p_inicial_condensate_gas">
                              <div class="form-group">
                                 {!! Form::label('presion_inicial_c_g', ' Initial Reservoir Pressure ') !!}<span style='color:red;'>*</span>
                                 <div class="input-group {{$errors->has('presion_inicial_c_g') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('presion_inicial_c_g',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_inicial_c_g']) !!}
                                    <span class="input-group-addon" id="basic-addon2">psi</span>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6 p_a_inicial_condensate_gas">
                              <div class="form-group">
                                 {!! Form::label('permeabilidad absoluta inicial', 'Absolute Permeability At Initial Reservoir Pressure ') !!}<span style='color:red;'>*</span>
                                 <div class="input-group {{$errors->has('permeabilidad_abs_ini_c_g') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('permeabilidad_abs_ini_c_g',null, ['placeholder' => 'md', 'class' =>'form-control', 'id' => 'permeabilidad_abs_ini_c_g']) !!}
                                    <span class="input-group-addon" id="basic-addon2">md</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 p_absoluta_condensate_gas" style="display: none;">
                           <div class="form-group">
                              {!! Form::label('permeabilidad_label', 'Absolute Permeability ') !!}<span style='color:red;'>*</span>
                              <div class="input-group {{$errors->has('permeabilidad') ? 'has-error' : ''}}">
                                 @if($advisor === "true")
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('espesor_reservorio_c_g') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('espesor_reservorio_c_g',null, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'espesor_reservorio_c_g']) !!}
                                    <span class="input-group-addon" id="basic-addon2">ft</span>
                                 </div>
                              </div>
                           </div>
                        ...
                        <fieldset class="u_p_module_condensate_gas">
                           <legend>
                              {!! Form::radio('check_use_permeability_module_c_g', 'check_use_permeability_module_c_g', true, ["id" => "check_use_permeability_module_c_g"]) !!}
                              <font size=3><b>Use Permeability Module</b></font>
                           </legend>
                                 ...
                                 <div class="col-md-10">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group {{$errors->has('modulo_permeabilidad_c_g') ? 'has-error' : ''}}">
                                          ...
                                          @endif
                                          {!! Form::text('modulo_permeabilidad_c_g',null, ['placeholder' => '1/psi', 'class' =>'form-control', 'id' => 'modulo_permeabilidad_c_g']) !!}
                                          <span class="input-group-addon" id="basic-addon2">psi<sup>-1</sup></span>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <fieldset class="c_p_module_condensate_gas">
                           <legend>
                           ...
                           <div class="check_calculate_permeability_c_g" style="display:none;">
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       {!! Form::label('permeabilidad_label_c_g', 'Absolute Permeability ') !!}<span style='color:red;'>*</span>
                                       <div class="input-group {{$errors->has('permeabilidad_c_g') ? 'has-error' : ''}}">
                                          ...
                                          @endif
                                          {!! Form::text('permeabilidad_c_g',$formacion->permeabilidad, ['placeholder' => 'md', 'class' =>'form-control', 'id' => 'permeabilidad_c_g']) !!}
                                          <span class="input-group-addon" id="basic-addon2">md</span>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group {{$errors->has('porosidad_c_g') ? 'has-error' : ''}}">
                                          ...
                                          @endif
                                          {!! Form::text('porosidad_c_g',$formacion->porosidad, ['placeholder' => 'Fraction', 'class' =>'form-control', 'id' => 'porosidad_c_g']) !!}
                                          <span class="input-group-addon" id="basic-addon2">Fraction</span>
                                       </div>
                                    </div>
                                 </div>
                     ...
                     <div id="Permeability_Relative" class="panel-collapse collapse in">
                        ...
                        <fieldset>
                              <div class="row">
                                 <div class="col-md-5">
                                    <fieldset>
                                       <legend align="center">Gas-Oil @if($advisor === "true")<span><i class="glyphicon glyphicon-info-sign show-table-advisor" id="code_table_excelgasliquid_c_g" style="color:black;font-size:15pt;"></i></span>@endif</legend>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('presion_saturacion') ? 'has-error' : ''}}">
                                    @if($advisor === "true")
                                       <span class="input-group-btn">
                                          <button type="button" class="btn btn-default button-advisor"><span class="glyphicon glyphicon-info-sign"></span></button>
                                       </span>
                                    @endif
                                    {!! Form::text('presion_saturacion',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_saturacion']) !!}
                                    <span class="input-group-addon" id="basic-addon2">psi</span>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="panel-body">
                              <div id="MP2" class="panel-collapse collapse in">
                                 <div class="panel-body">
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group" id="temperatura_id" style="display:none;">
                                             {!! Form::label('temperatura', 'Temperature') !!}<span style='color:red;'>*</span>
                                             <div class="input-group {{$errors->has('temperatura') ? 'has-error' : ''}}">
                                                {!! Form::text('temperatura',null, ['placeholder' => 'F', 'class' =>'form-control', 'id' => 'temperatura']) !!}
                                                <span class="input-group-addon" id="basic-addon2">F</span>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group" id="factor_compresibilidad_gas_id" style="display:none;">
                                             {!! Form::label('factor_compresibilidad_gas', 'Average Compressibility Factor') !!}<span style='color:red;'>*</span>
                                             <div class="input-group {{$errors->has('factor_compresibilidad_gas') ? 'has-error' : ''}}">
                                                {!! Form::text('factor_compresibilidad_gas',null, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'factor_compresibilidad_gas']) !!}
                                                <span class="input-group-addon" id="basic-addon2">-</span>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <div id="pvt_data_g" class="panel-collapse collapse in">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group" id="temperatura_id">
                                             ...
                                             <div class="input-group {{$errors->has('temperature_text_g') ? 'has-error' : ''}}">
                                                ...
                                                @endif
                                                {!! Form::text('temperature_text_g',null, ['placeholder' => 'F', 'class' =>'form-control', 'id' => 'temperature_text_g']) !!}
                                                <span class="input-group-addon" id="basic-addon2">F</span>
                                             </div>
                                          </div>
                                       </div>
                                 ...
                                 <fieldset>
                                    <div class="row" >
                                       <div class="col-md-12">
                                       <fieldset>
                                          <legend><h4>PVT Table @if($advisor === "true")<span><i class="glyphicon glyphicon-info-sign show-table-advisor" id="code_table_excel_tabular_pvt_fluid_g" style="color:black;font-size:15pt;"></i></span>@endif</h4></legend>
                                          <div id="excel_tabular_pvt_fluid_g" class="handsontable"></div>
                                       </fieldset>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-6">
               ...
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div id="MP" class="panel-collapse collapse in">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('presion_saturacion_c_g') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('presion_saturacion_c_g',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_saturacion_c_g']) !!}
                                    <span class="input-group-addon" id="basic-addon2">psi</span>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('gor_c_g') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('gor_c_g',null, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'gor_c_g']) !!}
                                    <span class="input-group-addon" id="basic-addon2">psi</span>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="col-md-12">
                           <h4 align="center">PVT Data @if($advisor === "true")<span><i class="glyphicon glyphicon-info-sign show-table-advisor" id="code_table_pvt_c_g" style="color:black;font-size:15pt;"></i></span>@endif</h4>
                           <hr>
                           ...
                           <p></p>
                           <h4 align="center">Drop-Out Data @if($advisor === "true")<span><i class="glyphicon glyphicon-info-sign show-table-advisor" id="code_table_drop_out_c_g" style="color:black;font-size:15pt;"></i></span>@endif</h4>
                           <hr>
                           <div class="row">
                              <div class="col-md-5">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('tipo_roca') ? 'has-error' : ''}}">
                           <select name="rock_type_modal" class="form-control" id="rock_type_modal">
                              <option value="1">Consolidated</option>
                              <option value="2" >Unconsolidated</option>
                              <option value="3">Microfractured</option>
                           </select>
