	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-12">
					<div class="row">{!! Form::hidden('filtration_function_factors_option', 0, array('id' => 'filtration_function_factors_option')) !!}</div>
								...
								<div class="col-md-6">
									<div class="form-group {{$errors->has('mud_density_factors') ? 'has-error' : ''}}">
									   ...
									   <div class="input-group" id="mud_density_factors_input">
									      {!! Form::text('mud_density_factors',null, ['placeholder' => 'lb/gal', 'class' =>'form-control','id'=>'mud_density_factors']) !!}
								...
								<div class="col-md-6">
									<div class="form-group {{$errors->has('kdki_cement_slurry_factors') ? 'has-error' : ''}}">
									   ...
									   <div class="input-group" id="kdki_cement_slurry_factors_input">
									      {!! Form::text('kdki_cement_slurry_factors',null, ['placeholder' => '-', 'class' =>'form-control','id'=>'kdki_cement_slurry_factors']) !!}
								...
								<div class="col-md-6">
									<div class="form-group {{$errors->has('kdki_mud_factors') ? 'has-error' : ''}}">
									   ...
									   <div class="input-group" id="kdki_mud_factors_input">
									      {!! Form::text('kdki_mud_factors',null, ['placeholder' => '-', 'class' =>'form-control','id'=>'kdki_mud_factors']) !!}
								...
								<div class="col-md-6">
									<div class="form-group {{$errors->has('core_diameter_factors') ? 'has-error' : ''}}">
									   ...
									   <div class="input-group" id="core_diameter_factors_input">
									      {!! Form::text('core_diameter_factors',null, ['placeholder' => '-', 'class' =>'form-control','id'=>'core_diameter_factors']) !!}
