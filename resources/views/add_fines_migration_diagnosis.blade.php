                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('perforation_density') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('perforation_density', null,  ['placeholder' => '-', 'class' =>'form-control', 'id' => 'perforation_density']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('current_permeability') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('current_permeability', null,  ['placeholder' => 'mD', 'class' =>'form-control', 'id' => 'current_permeability']) !!}
                                 <span class="input-group-addon" id="basic-addon2">mD</span>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('current_pressure') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('current_pressure', null,  ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'current_pressure']) !!}
                                 <span class="input-group-addon" id="basic-addon2">psi</span>
                              </div>
                           </div>
                        </div>
