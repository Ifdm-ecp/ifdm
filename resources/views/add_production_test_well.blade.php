...
{!!Form::open(['action' => ['add_production_test_well_controller@store', 'pozoId' => $pozo], 'method' => 'post'])!!}
<div class="col-md-12">
...
<div class="row">
   <div class="col-xs-12">
      ...
      <p class="pull-right">
         {!! Form::submit('Add' , array('class' => 'btn btn-primary', 'OnClick'=>'javascript: Mostrar();')) !!}
...
@section('Scripts')
  ...
  @include('js/add_production_test_well')
