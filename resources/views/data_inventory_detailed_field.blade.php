...
<div class="row">
  <div class="panel panel-default">
      <div class="panel-body">
        ...
        <p align="justify">In the Detailed Data Inventory module, the user can check the existent and missing information for each field in database.</p>
        <br>
        <div class="row">
          <div class="col-md-4">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4><a data-parent="#accordion" data-toggle="collapse" href="#oil_ipr_data"><span class="chevron_toggleable glyphicon glyphicon-chevron-down pull-right"></span></a>IPR Data</h4>
          </div>
            <div class="panel-body">
...
@section('Scripts')
@include('js/data_inventory_detailed_field')
@endsection