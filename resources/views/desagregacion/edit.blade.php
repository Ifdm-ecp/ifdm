                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group {{$errors->has('mixture_oil_specific_gravity_1_1') ? 'has-error' : ''}}">
                                    ...
                                    <div class="input-group">
                                       {!! Form::text('mixture_oil_specific_gravity_1_1', $disaggregation->mixture_oil_specific_gravity_1_1, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'mixture_oil_specific_gravity_1_1']) !!}
                                       <span class="input-group-addon" id="basic-addon2">-</span>
                                    </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group {{$errors->has('mixture_water_specific_gravity_1_1') ? 'has-error' : ''}}">
                                    ...
                                    <div class="input-group">
                                       {!! Form::text('mixture_water_specific_gravity_1_1', $disaggregation->mixture_water_specific_gravity_1_1, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'mixture_water_specific_gravity_1_1']) !!}
                                       <span class="input-group-addon" id="basic-addon2">-</span>
                                    </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group {{$errors->has('mixture_oil_specific_gravity_1_2') ? 'has-error' : ''}}">
                                    ...
                                    <div class="input-group">
                                       {!! Form::text('mixture_oil_specific_gravity_1_2', $disaggregation->mixture_oil_specific_gravity_1_2, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'mixture_oil_specific_gravity_1_2']) !!}
                                       <span class="input-group-addon" id="basic-addon2">-</span>
                                    </div>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group {{$errors->has('mixture_water_specific_gravity_1_2') ? 'has-error' : ''}}">
                                    ...
                                    <div class="input-group">
                                       {!! Form::text('mixture_water_specific_gravity_1_2', $disaggregation->mixture_water_specific_gravity_1_2, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'mixture_water_specific_gravity_1_2']) !!}
                                       <span class="input-group-addon" id="basic-addon2">-</span>
                                    </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group {{$errors->has('mixture_oil_specific_gravity_2') ? 'has-error' : ''}}">
                                    ...
                                    <div class="input-group">
                                       {!! Form::text('mixture_oil_specific_gravity_2', $disaggregation->mixture_oil_specific_gravity_2, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'mixture_oil_specific_gravity_2']) !!}
                                       <span class="input-group-addon" id="basic-addon2">-</span>
                                    </div>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group {{$errors->has('mixture_water_specific_gravity_2') ? 'has-error' : ''}}">
                                    ...
                                    <div class="input-group">
                                       {!! Form::text('mixture_water_specific_gravity_2', $disaggregation->mixture_water_specific_gravity_2, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'mixture_water_specific_gravity_2']) !!}
                                       <span class="input-group-addon" id="basic-addon2">-</span>
                                    </div>
