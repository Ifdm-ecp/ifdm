...
<div>
    ...
    <div id="sticky"><center>
        <b>Scenario:</b> {!! $scenary_s->nombre !!} <br> Field: {!! $campo->nombre !!} - Producing interval: {!!  $intervalo->nombre !!} - Well: {!! $pozo->nombre !!}</center></div>
    </br>
    <br>
    @if(isset($error)) 
        <div class="jumbotron">
            <center>
                <span>Run has not been executed, please check input data. {!! $error !!}</span>
            </center>
        </div>
        ...
        @if(!$desagregacion->status_wr)
            @if(isset($mechanical_result)) 
                ...
                @else
                    <div class="jumbotron">
                        <center>
                            <span>Run has not been executed, please check input data.</span>
                        </center>
                    </div>
                @endif
            @endif
