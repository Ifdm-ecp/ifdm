      ...
      <div class="tab-content">
               ...
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div id="GD" class="panel-collapse collapse in">
                        {!! Form::model('drilling_scenario', ['url'=>'Drilling/update/'.(isset($_SESSION["scenary_id_dup"]) ? $_SESSION["scenary_id_dup"] : $scenario->id), 'method' => 'post']) !!}
                        ...
                        <div class="row">
                           <div class="col-md-6">
                             <div class="form-group {{$errors->has('intervalSelect') ? 'has-error' : ''}}">
                               ...
                               {!! Form::select('intervalSelect', $scenario->formacionxpozo->pozo->formacionesxpozo->pluck('nombre', 'id'),null, array('placeholder' => '', 'class'=>'form-control selectpicker show-tick', 'data-live-search'=>'true', 'data-style'=>'btn-default', 'id'=>'intervalSelect', 'multiple')) !!}
                             </div>
                           </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                             <div class="form-group {{$errors->has('inputDataMethodSelect') ? 'has-error' : ''}}">
                               ...
                               {{--{!! Form::select('inputDataMethodSelect', array('1'=>'Profile', '2'=>'By Intervals'),null, array('placeholder' => '', 'class'=>'form-control selectpicker show-tick', 'data-live-search'=>'true', 'data-style'=>'btn-default', 'id'=>'inputDataMethodSelect')) !!}--}}
                               {!! Form::select('inputDataMethodSelect', array('1'=>'Profile'),null, array('placeholder' => '', 'class'=>'form-control selectpicker show-tick', 'data-live-search'=>'true', 'data-style'=>'btn-default', 'id'=>'inputDataMethodSelect')) !!}
                  ...
                  <div class="panel-body">
                     <div id="DD" class="panel-collapse collapse in">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 {!! Form::label('d_mud_density_l', 'Max Mud Density') !!} <span style='color:red;'>*</span>
         ...
         <div id="cementing_data" class="tab-pane" >
            ...
            {{--
               <div class="panel panel-default">
                     <div class="panel-heading">
                        <h4><a data-parent="#accordion" data-toggle="collapse" href="#CD"><span class="chevron_toggleable glyphicon glyphicon-chevron-down pull-right"></span></a> Cementing Data</h4>
                     </div>
                     <div class="panel-body">
                        <div id="CD" class="panel-collapse collapse in">
                           <div class="row">
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 {!! Form::submit('Run' , array('class' => 'btn btn-primary', 'onclick' => 'verifyDrilling();', 'name' => 'accion', 'id'=>'run')) !!}
                              </div>
                           </div>
                        </div>
                     </div>
