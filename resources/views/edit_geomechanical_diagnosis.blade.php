...
<div id="sticky">
   <center><b>Scenario: </b>{!! $scenario->nombre !!} </br> Basin: {!! $basin->nombre !!} - Field: {!! $field->nombre !!} - Producing interval: {!!  $interval->nombre !!} - Well: {!!  $_SESSION['well'] !!} - User: {!! $user->fullName !!}</center>
</div>

</br>

{!! Form::open(array('url'=>'geomechanical_diagnosis_update', 'method' => 'post')) !!}
<input type="hidden" name="id_scenary" id="id_scenary" value="{{ !empty($duplicateFrom) ? $duplicateFrom : $scenario->id }}">
<div class="nav">
   <div class="tabbable">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('well_azimuth') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('well_azimuth',$geomechanical_diagnosis_scenario->well_azimuth, ['placeholder' => '°', 'class' =>'form-control', 'id' => 'well_azimuth']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('well_dip') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('well_dip',$geomechanical_diagnosis_scenario->well_dip, ['placeholder' => '°', 'class' =>'form-control', 'id' => 'well_dip']) !!}
                           <span class="input-group-addon" id="basic-addon2">°</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('well_radius') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('well_radius',$geomechanical_diagnosis_scenario->well_radius, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'well_radius']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('drainage_radius') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('drainage_radius',$geomechanical_diagnosis_scenario->drainage_radius, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'drainage_radius']) !!}
                           <span class="input-group-addon" id="basic-addon2">ft</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                         ...
                         <div class="input-group {{$errors->has('max_analysis_radius') ? 'has-error' : ''}}">
                            ...
                            @endif
                            {!! Form::text('max_analysis_radius',$geomechanical_diagnosis_scenario->max_analysis_radius, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'max_analysis_radius']) !!}
                            <span class="input-group-addon" id="basic-addon2">ft</span>
                         </div>
                      </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                       ...
                       <div class="input-group {{$errors->has('rate') ? 'has-error' : ''}}">
                          ...
                          @endif
                          {!! Form::text('rate',$geomechanical_diagnosis_scenario->rate, ['placeholder' => 'bbl/day', 'class' =>'form-control', 'id' => 'rate']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('matrix_permeability') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('matrix_permeability',$geomechanical_diagnosis_scenario->matrix_permeability, ['placeholder' => 'mD', 'class' =>'form-control', 'id' => 'matrix_permeability']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('top') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('top',$geomechanical_diagnosis_scenario->top, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'top']) !!}
                           <span class="input-group-addon" id="basic-addon2">ft</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('netpay') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('netpay',$geomechanical_diagnosis_scenario->netpay, ['placeholder' => 'ft', 'class' =>'form-control', 'id' => 'netpay']) !!}
                           <span class="input-group-addon" id="basic-addon2">ft</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('viscosity') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('viscosity',$geomechanical_diagnosis_scenario->viscosity, ['placeholder' => 'cp', 'class' =>'form-control', 'id' => 'viscosity']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('volumetric_factor') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('volumetric_factor',$geomechanical_diagnosis_scenario->volumetric_factor, ['placeholder' => 'RB/STB', 'class' =>'form-control', 'id' => 'volumetric_factor']) !!}
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                         ...
                         <div class="input-group {{$errors->has('reservoir_pressure') ? 'has-error' : ''}}">
                            ...
                            @endif
                            {!! Form::text('reservoir_pressure',$geomechanical_diagnosis_scenario->reservoir_pressure, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'reservoir_pressure']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('poisson_ratio') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('poisson_ratio',$geomechanical_diagnosis_scenario->poisson_ratio, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'poisson_ratio']) !!}
                           <span class="input-group-addon" id="basic-addon2">-</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('biot_coefficient') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('biot_coefficient',$geomechanical_diagnosis_scenario->biot_coefficient, ['placeholder' => '-', 'class' =>'form-control', 'id' => 'biot_coefficient']) !!}
                           <span class="input-group-addon" id="basic-addon2">-</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('azimuth_maximum_horizontal_stress') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('azimuth_maximum_horizontal_stress',$geomechanical_diagnosis_scenario->azimuth_maximum_horizontal_stress, ['placeholder' => '°', 'class' =>'form-control', 'id' => 'azimuth_maximum_horizontal_stress']) !!}
                           <span class="input-group-addon" id="basic-addon2">°</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('minimum_horizontal_stress_gradient') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('minimum_horizontal_stress_gradient',$geomechanical_diagnosis_scenario->minimum_horizontal_stress_gradient, ['placeholder' => 'psi/ft', 'class' =>'form-control', 'id' => 'minimum_horizontal_stress_gradient']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('vertical_stress_gradient') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('vertical_stress_gradient',$geomechanical_diagnosis_scenario->vertical_stress_gradient, ['placeholder' => 'psi/ft', 'class' =>'form-control', 'id' => 'vertical_stress_gradient']) !!}
                           <span class="input-group-addon" id="basic-addon2">psi/ft</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('maximum_horizontal_stress_gradient') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('maximum_horizontal_stress_gradient',$geomechanical_diagnosis_scenario->maximum_horizontal_stress_gradient, ['placeholder' => 'psi/ft', 'class' =>'form-control', 'id' => 'maximum_horizontal_stress_gradient']) !!}
                           <span class="input-group-addon" id="basic-addon2">psi/ft</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('initial_fracture_width') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('initial_fracture_width',$geomechanical_diagnosis_scenario->initial_fracture_width, ['placeholder' => 'μm', 'class' =>'form-control', 'id' => 'initial_fracture_width']) !!}
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('initial_fracture_toughness') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('initial_fracture_toughness',$geomechanical_diagnosis_scenario->initial_fracture_toughness, ['placeholder' => 'psi/ft', 'class' =>'form-control', 'id' => 'initial_fracture_toughness']) !!}
                           <span class="input-group-addon" id="basic-addon2">psi/ft</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('fracture_closure_permeability') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('fracture_closure_permeability',$geomechanical_diagnosis_scenario->fracture_closure_permeability, ['placeholder' => 'mD', 'class' =>'form-control', 'id' => 'fracture_closure_permeability']) !!}
                           <span class="input-group-addon" id="basic-addon2">mD</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group {{$errors->has('residual_fracture_closure_permeability') ? 'has-error' : ''}}">
                           ...
                           @endif
                           {!! Form::text('residual_fracture_closure_permeability',$geomechanical_diagnosis_scenario->residual_fracture_closure_permeability, ['placeholder' => 'mD', 'class' =>'form-control', 'id' => 'residual_fracture_closure_permeability']) !!}
                           <span class="input-group-addon" id="basic-addon2">mD</span>
                        </div>
                     </div>
                  </div>
...
<div class="row">
   <div class="col-xs-12">
      <p class="pull-right">
        {!! Form::submit('Save' , array('class' => 'maximize btn btn-success', 'onclick' => 'verify_geomechanical_diagnosis_data(false);', 'name' => 'button_sw', 'id'=>'button_sw')) !!}
        {!! Form::submit('Run' , array('class' => 'maximize btn btn-primary', 'onclick' => 'verify_geomechanical_diagnosis_data(true);', 'name' => 'action', 'id'=>'run')) !!}
...
@section('Scripts')
   ...
   @include('js/edit_geomechanical_diagnosis')
