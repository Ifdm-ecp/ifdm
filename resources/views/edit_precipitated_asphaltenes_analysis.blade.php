...
{!!Form::model($asphaltenes_d_precipitated_analysis, array('route' => array('asphaltenesPrecipitated.update', $asphaltenes_d_precipitated_analysis->id), 'method' => 'PATCH', 'id' => 'asphalteneForm'), array('role' => 'form'))!!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group {{$errors->has('initial_reservoir_pressure') ? 'has-error' : ''}}">
                              ...
                              @endif
                              {!! Form::text('initial_reservoir_pressure',$asphaltenes_d_precipitated_analysis->initial_reservoir_pressure, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'initial_reservoir_pressure']) !!}
                              <span class="input-group-addon" id="basic-addon2">psi</span>
                           </div>
