...
{!!Form::open(['action' => ['edit_production_test_well_controller@store', 'pozoId' => $pozo], 'method' => 'post'])!!}
<div class="col-md-12">
...
<div class="row">
   <div class="col-xs-12">
      ...
      <p class="pull-right">
         {!! Form::submit('Next' , array('class' => 'btn btn-primary', 'OnClick'=>'javascript: Mostrar();')) !!}
...
@section('Scripts')
  ...
  @include('js/edit_production_test_well')
