...
<div id="page_1">
<div class="masthead">
   <h2>Well - <small>{{$pozo->nombre}}</small></h2>
   <br/>
</div>

<div onload="well();">
   {!!Form::model($pozo, array('route' => array('listWellC.update', $pozo->id), 'method' => 'PATCH', 'id'=>'form'), array('role' => 'form'))!!}
   <div id="well">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="form-group {{$errors->has('field') ? 'has-error' : ''}}">
                     ...
                     {!! Form::select('field', $campo->lists('nombre','id'),null, array('placeholder' => '', 'class'=>'form-control selectpicker show-tick', 'data-live-search'=>'true', 'data-style'=>'btn-default', 'id'=>'field')) !!}
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group {{$errors->has('nameWell') ? 'has-error' : ''}}">
                     ...
                     {!! Form::text('nameWell', $pozo->nombre, array('class' => 'form-control','id'=>'nameWell')) !!}
                  </div>
               </div>
               <div class="col-md-6">
                    <div class="form-group {{$errors->has('uwi') ? 'has-error' : ''}}">
                        {!! Form::label('uwi_label', 'UWI') !!}{!! Form::label('*', '*', array('class' => 'red')) !!}
                        {!! Form::text('uwi', $pozo->uwi, array('class' => 'form-control','id'=>'uwi')) !!}
                    </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-md-6">
                  <div class="form-group {{$errors->has('wellRadius') ? 'has-error' : ''}}">
                     ...
                     <div class="input-group">
                        {!! Form::text('wellRadius',$pozo->radius, ['placeholder' => 'ft', 'class' =>'form-control','id'=>'wellRadius']) !!}
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group {{$errors->has('drainageRadius') ? 'has-error' : ''}}">
                     ...
                     <div class="input-group">
                        {!! Form::text('drainageRadius',$pozo->drainage_radius, ['placeholder' => 'ft', 'class' =>'form-control','id'=>'drainageRadius']) !!}
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group {{$errors->has('XW') ? 'has-error' : ''}}">
                     ...
                     <div class="input-group">
                        {!! Form::text('XW',$pozo->lat, ['placeholder' => '°', 'class' =>'form-control','id'=>'XW']) !!}
               ...
               <div class="col-md-6">
                  <div class="form-group {{$errors->has('YW') ? 'has-error' : ''}}">
                     ...
                     <div class="input-group">
                        {!! Form::text('YW',$pozo->lon, ['placeholder' => '°', 'class' =>'form-control','id'=>'YW']) !!}
                        <span class="input-group-addon" id="basic-addon2">°</span>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group {{$errors->has('TDVW') ? 'has-error' : ''}}">
                     ...
                     <div class="input-group">
                        {!! Form::text('TDVW',$pozo->tdv, ['placeholder' => 'ft', 'class' =>'form-control','id'=>'TDVW']) !!}
   ...
   <div class="row">
      <div class="col-xs-12">
         <p class="pull-right">
            {!! Form::hidden('id', $pozo->id) !!}
            {!! Form::button('Next' , array('class' => 'btn btn-primary', 'type' => 'button', 'data-toggle' => 'modal', 'OnClick'=>'javascript: Mostrar();')) !!}
            <a href="{!! url('listWellC') !!}" class="btn btn-danger" role="button">Cancel</a>
         </p>
         {!! Form::Close() !!}
      </div>
   </div>
...
<div class="modal fade" id="myModalPD" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
