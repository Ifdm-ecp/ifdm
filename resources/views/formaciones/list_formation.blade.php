...
<div name="table" id="table">
   <table class="table table-striped ">
      ...
      <tr>
         <td>{{ $formations->nombre }}</td>
         <td>
            {!! Form::open(['method' => 'DELETE', 'route' => ['listFormationC.destroy', $formations->id], 'id' => 'form'.$formations->id ]) !!}
            <form class="form-inline">
               <a href="{{ URL::route('listFormationC.edit', $formations->id) }}" class="btn btn-warning">Manage</a>
               <button class="btn btn-danger" type="button" data-toggle="modal" OnClick="javascript: Mostrar({{ $formations->id}});">Delete</button>
            </form>
            {!! Form::close() !!}
         </td>
      </tr>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <p>Do You Want To Delete This Formation?</p>
         </div>
