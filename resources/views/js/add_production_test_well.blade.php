...
<script type="text/javascript">
    ...
    //Crear grafico para valores de tabla PLT
    ...
    //Inicializar variables para la creacion de tablas
    var maxed = false,
    ...
    $(document).ready(function() {
        ...
        //Crear tabla y cargar contenido pre-cargado en la BD
        var prods = [];
        $.get("{!! url('excel80') !!}", {
            pozo: <?php echo $pozo ?>
        }, function(data) {
    ...
    //Funcion para validar datos ingresados en las tablas
    function Mostrar() {
        var valid = true;
        var mensaje_ = "";
