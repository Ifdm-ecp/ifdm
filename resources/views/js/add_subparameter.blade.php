<script type="text/javascript">
    ...
    //Funcion para msotrar y ocultar contenido de botones de tablas
    $(function() {
        $("#myModal").modal('show');
    ...
    //Mostrar y ocultar valor de pestañas
    function MS() {
    ...
    $(document).ready(function() {
        ...
        //Validar pesos de SP por cada parametro
        ...
        //Disabled plot para evitar que el usuario grafique antes de guardar valores
        $('#plot').addClass('disabled');
        $('#plot').attr("data-toggle", "modal");

        //Asignar mensaje a input en caso de que el usuario modifique un valor para cada SP
        ...
        //Contador de pesos de SP. Mostrar ventana de error
        ...
        //Cargar valores de SP de acuerdo a estadisticas de la BD
        $(document).ready(function() {
            var nps = [];
            var d;
            var p50;
            ...
            $.get("{!! url('P') !!}", {
                ...
                $.each(data, function(index, value) {
                    ...
                    if (count < 1) {
                        document.getElementById("p10_" + i).value = p10;
                        document.getElementById("p90_" + i).value = p90;
                    }
