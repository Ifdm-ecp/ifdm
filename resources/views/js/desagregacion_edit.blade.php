...
$(document).ready(function()
{
  ...
  /** Crear la tabla de unidades hidráulicas y la de unidades hidráulicas con FZI escondida*/
  create_hydraulic_units_data();

  /** Asignar color a pestañas recarga de página*/ 
  //validate_form_data();

  /** Asignar color a pestañas dinámicamente */
...
function create_hydraulic_units_data()
{
  ...
  for (var i = hidraulic_units_data.length - 1; i >= 0; i--) {
    hidraulic_units_data[i].splice(1, 1);
  }
