...
<script type="text/javascript">   
    ...
    $(document).ready(function() {
        ...
        $.get("{!! url('asphaltenes_d_stability_analysis_results') !!}", {
            ...
            field = data.campo.field_name;

            f_boer_chart(boer_stability_analysis_chart_point, field);
            f_cii_chart(colloidal_analysis_chart_point, field);
            f_stankiewicz_chart(stankiewicz_analysis_chart_point, field);
