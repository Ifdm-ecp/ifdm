...
<div id="sticky" style="position: relative;">
   <center><b>Scenario: </b>{!! $escenario->nombre !!} </br> Basin: {!! $escenario->cuenca->nombre !!} - Field: {!! $escenario->campo->nombre !!} - Producing interval: {!! $escenario->formacionxpozo->nombre !!} - Well: {!!  $escenario->pozo->nombre !!} - User: {!! $escenario->user->name !!}</center>
</div>
            ...
            <div class="panel-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    {!! Form::text('viscosity_oil',null, ['class' =>'form-control', 'placeholder' => 'cP']) !!}
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    {!! Form::text('volumetric_factor_oil',null, ['class' =>'form-control', 'placeholder' => '-']) !!}
                    <span class="input-group-addon" id="basic-addon2">-</span>
                  </div>
                </div>
              </div>
            ...
            <div class="panel-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    {!! Form::text('viscosity_gas',null, ['class' =>'form-control', 'placeholder' => 'cP']) !!}
                    <span class="input-group-addon" id="basic-addon2">cP</span>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6" id="input_oil">
              <div class="form-group">
                ...
                <div class="input-group">
                  {!! Form::text('fluid_rate_oil',$escenario->pozo->oil_rate, ['class' =>'form-control', 'placeholder' => 'SBT/D']) !!}
            ...
            <div class="col-md-6" id="input_gas">
              <div class="form-group">
                ...
                <div class="input-group">
                  {!! Form::text('fluid_rate_gas',$escenario->pozo->gas_rate, ['class' =>'form-control', 'placeholder' => 'MMSCF/D']) !!}
