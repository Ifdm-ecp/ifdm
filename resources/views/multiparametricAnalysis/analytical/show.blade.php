...
@if(is_null($analytical->status_wr) || !$analytical->status_wr)
</br>
<hr>
<div class="row">
  <div class="col-md-6">
...
<p class="pull-right">            
  <a href="{{route('analytical.edit', $analytical->id)}}" class="btn btn-warning" role="button">Edit</a>
