...
@if((is_null($analytical->status_wr) || !$analytical->status_wr) && (is_null($statistical->status_wr) || !$statistical->status_wr))
</br>
<hr>
    <div class="row">
      <div class="col-md-6">
          <center><h2>Average Skin Disaggregation</h2></center>
...
<hr>
   <div class="row">
      <div class="col-md-6">
        <center><h2>Statistical Skin Disaggregation</h2></center>
         <div  id="containerStatistical"></div>
      </div>
      <div class="col-md-4 col-md-offset-1">
         <p> </p>            
         <p> </p>            
...
<hr>
    <div class="row">
      <div class="col-md-6">
        <center><h2>Analytical Skin Disaggregation</h2></center>
         <div  id="containerAnalytical"></div>
      </div>
      <div class="col-md-4 col-md-offset-1">
         <p> </p>            
         <p> </p>            
...
@endif
<p class="pull-right">            
   <a href="{{route('completeMultiparametric.edit', $statistical->id)}}" class="btn btn-warning" role="button">Edit</a>
...
@section('Scripts')
    ...
    <script type="text/javascript">
       $(document).ready(function(){
            graficarStatistical();
            tablaGraficarStatistical();
            graficarAnalytical();
            tablaGraficarAnalytical();
            graficarAverage();
            tablaGraficarAverage();
       });


      function graficarStatistical()
      {
         $('#containerStatistical').highcharts({
            ...
            series: [{
                ...
                data: {{$datosStatistical}},
                pointPlacement: 'on'
            }]
         });
      }

      function tablaGraficarStatistical()
      {
         var data = {{$datosStatistical}};
      ...
      function graficarAnalytical()
      {
         $('#containerAnalytical').highcharts({
            ...
            series: [{
                name: "Analytical Skin",
                data: {{$datosAnalytical}},
                pointPlacement: 'on'
            }]
         });
      }
      ...
      function tablaGraficarAnalytical()
      {
         var data = {{$datosAnalytical}};
         var data_table_final = [];
       ...
       function graficarAverage()
      {
         $('#containerAverage').highcharts({
      ...
      function tablaGraficarAverage()
      {
         var data = {{$datosAverage}};
         var data_table_final = [];
