<script type="text/javascript">
    $( document ).ready(function() {
        ...
        @if(isset($OverwriteP10P90) )
            console.log(<?php echo $OverwriteP10P90 ?>);
        @endif
    ...
    function addInputGroup() {
        ...
        @foreach($titles1 as $k => $title1)
            ...
            @foreach($formationsWithoutSpaces as $j => $formationWithoutSpaces)
                ...
                html = html + organizeSelectOptions('<?php echo $title1 ?>', '<?php echo $formationWithoutSpaces ?>', <?php echo json_encode($mediciones); ?>);   
