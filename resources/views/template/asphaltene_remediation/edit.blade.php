...
<div id="sticky">
   <center>
      {!! Form::label('Scenario: ') !!} {!! $scenary_s->nombre !!} {!! Form::label(' - Basin: ') !!} {!! $basin->nombre !!} {!! Form::label(' - Field: ') !!} {!! $campo->nombre !!} {!! Form::label(' - Well: ') !!} {!!  $pozo->nombre !!} {!! Form::label(' - User: ') !!} {!! $user->fullName !!}
   </center>
</div>
</br>
<!-- ***  -->
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div id="petrophysic_pleg" class="panel-collapse collapse in">
                     ...
                     {!!Form::open(array('id' => 'form_asphaltene', 'url' => url('asphalteneremediation/update',$asphaltene->id), 'method' => 'post','autocomplete'=>"off"))!!}

                     <input type="hidden" name="id_scenary" id="id_scenary" value="{{ !empty($duplicateFrom) ? $duplicateFrom : $scenary_s->id }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('initial_porosity') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('initial_porosity',$asphaltene->initial_porosity, ['placeholder' => 'Initial Porosity', 'class' =>'form-control', 'id' => 'initial_porosity']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('net_pay') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('net_pay',$asphaltene->net_pay, ['placeholder' => 'Net Pay', 'class' =>'form-control', 'id' => 'net_pay']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('water_saturation') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('water_saturation',$asphaltene->water_saturation, ['placeholder' => 'Water Saturation', 'class' =>'form-control', 'id' => 'water_saturation']) !!}
                                 <span class="input-group-addon" id="basic-addon2">[ Fraction ]</span>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('initial_permeability') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('initial_permeability',$asphaltene->initial_permeability, ['placeholder' => 'Initial Permeability', 'class' =>'form-control', 'id' => 'initial_permeability']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('current_permeability') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('current_permeability',$asphaltene->current_permeability, ['placeholder' => 'Current Permeability', 'class' =>'form-control', 'id' => 'current_permeability']) !!}
                                 <span class="input-group-addon" id="basic-addon2">[ mD ]</span>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <input type="hidden" name="excel_changes_along_the_radius_input" id="excel_changes_along_the_radius_input" value="{{ $asphaltene->excel_changes_along_the_radius }}">
                        </div>
                     </div>
                     @endif
                  ...
                  <div id="skin_characterization_pleg" class="panel-collapse collapse in">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('skin_characterization_scale') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('skin_characterization_scale',$asphaltene->skin_characterization_scale, ['placeholder' => 'Scale', 'class' =>'form-control', 'id' => 'skin_characterization_scale']) !!}
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('skin_characterization_induced') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('skin_characterization_induced',$asphaltene->skin_characterization_induced, ['placeholder' => 'Induced', 'class' =>'form-control', 'id' => 'skin_characterization_induced']) !!}
                                    <span class="input-group-addon" id="basic-addon2">[ % ]</span>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('skin_characterization_asphaltene') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('skin_characterization_asphaltene',$asphaltene->skin_characterization_asphaltene, ['placeholder' => 'Asphaltene', 'class' =>'form-control', 'id' => 'skin_characterization_asphaltene']) !!}
                                    <span class="input-group-addon" id="basic-addon2">[ % ]</span>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('skin_characterization_fines') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('skin_characterization_fines',$asphaltene->skin_characterization_fines, ['placeholder' => 'Fines', 'class' =>'form-control', 'id' => 'skin_characterization_fines']) !!}
                                    <span class="input-group-addon" id="basic-addon2">[ % ]</span>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 {!! Form::label('skin_characterization_non_darcy', 'Non Darcy') !!}<span style='color:red;'>*</span>
                                 <div class="input-group {{$errors->has('skin_characterization_non_darcy') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('skin_characterization_non_darcy',$asphaltene->skin_characterization_non_darcy, ['placeholder' => 'Non Darcy', 'class' =>'form-control', 'id' => 'skin_characterization_non_darcy']) !!}
                                    <span class="input-group-addon" id="basic-addon2">[ % ]</span>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 {!! Form::label('skin_characterization_geomechanical', 'Geomechanical') !!}<span style='color:red;'>*</span>
                                 <div class="input-group {{$errors->has('skin_characterization_geomechanical') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('skin_characterization_geomechanical',$asphaltene->skin_characterization_geomechanical, ['placeholder' => 'Geomechanical', 'class' =>'form-control', 'id' => 'skin_characterization_geomechanical']) !!}
                                    <span class="input-group-addon" id="basic-addon2">[ % ]</span>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('asphaltene_apparent_density') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('asphaltene_apparent_density',$asphaltene->asphaltene_apparent_density, ['placeholder' => 'Asphaltene Apparent Density', 'class' =>'form-control', 'id' => 'asphaltene_apparent_density']) !!}
               ...
               <div class="panel-body">
                  <div id="treatment_reward_pleg" class="panel-collapse collapse in">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <legend>
                              <input type="checkbox" name="stimate_ior" id="stimate_ior" {{ ($asphaltene->stimate_ior == 'on') ? 'checked' : '' }}>
                              <input type="hidden" name="stimate_ior_input" id="stimate_ior_input" value="{{ $asphaltene->stimate_ior }}">
                        ...
                        <div id="stimate_ior_checked">
                                 ...
                                 <div class="form-group">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group {{$errors->has('monthly_decline_rate') ? 'has-error' : ''}}">
                                          ...
                                          @endif
                                          {!! Form::text('monthly_decline_rate', $asphaltene->monthly_decline_rate, ['placeholder' => 'Monthly Decline Rate', 'class' =>'form-control', 'id' => 'monthly_decline_rate']) !!}
                                          <span class="input-group-addon" id="basic-addon2">[ Fraction ]</span>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group {{$errors->has('data_input') || $errors->has('current_oil_production') ? 'has-error' : ''}}">
                                    <div class="input-group ">
                                       ...
                                       @endif
                                       <input type="text" name="current_oil_production" class="form-control" placeholder="Current Oil Production" id="current_oil_production" value="{{ $asphaltene->current_oil_production }}">
                                       <span class="input-group-addon" id="basic-addon1">[ bbl/day ]</span>

                                       <input type="text" name="data_input" class="form-control datepicker" placeholder="Date with format YYYY/MM/DD" id="data_input" value="{{ $asphaltene->data_input }}">
               ...
               <div class="panel-body">
                  <div id="treatment_data_pleg" class="panel-collapse collapse in">
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <input type="radio" class="form-button" value="yes" name="chemical_treatment_impl" {{ $asphaltene->chemical_treatment_impl == 'yes' ? 'checked' : '' }} id="chemical_treatment_impl_yes">  Enter manually
                           <input type="radio" class="form-button" value="no" name="chemical_treatment_impl" {{ $asphaltene->chemical_treatment_impl == 'no' ? 'checked' : '' }} id="chemical_treatment_impl_no">  Import from library
                        </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('asphaltene_dilution_capacity') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('asphaltene_dilution_capacity',$asphaltene->asphaltene_dilution_capacity, ['placeholder' => 'Asphaltene Dilution Capacity', 'class' =>'form-control', 'id' => 'asphaltene_dilution_capacity']) !!}
                              ...
                              <div class="form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group {{$errors->has('treatment_radius') ? 'has-error' : ''}}">
                                       ...
                                       @endif
                                       {!! Form::text('treatment_radius',$asphaltene->treatment_radius, ['placeholder' => 'Treatment Radius', 'class' =>'form-control', 'id' => 'treatment_radius']) !!}
                                       <span class="input-group-addon" id="basic-addon2">[ ft]</span>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group {{$errors->has('wellbore_radius') ? 'has-error' : ''}}">
                                       ...
                                       @endif
                                       {!! Form::text('wellbore_radius',$asphaltene->wellbore_radius, ['placeholder' => 'Wellbore Radius', 'class' =>'form-control', 'id' => 'wellbore_radius']) !!}
                                       <span class="input-group-addon" id="basic-addon2">[ ft]</span>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    @endif
                                    {!! Form::text('asphaltene_remotion_efficiency_range_a',$asphaltene->asphaltene_remotion_efficiency_range_a, ['placeholder' => 'Range start', 'class' =>'form-control', 'id' => 'asphaltene_remotion_efficiency_range_a']) !!}
                                    <span class="input-group-addon" id="basic-addon1">-</span>
                                    {!! Form::text('asphaltene_remotion_efficiency_range_b',$asphaltene->asphaltene_remotion_efficiency_range_b, ['placeholder' => 'Range end', 'class' =>'form-control', 'id' => 'asphaltene_remotion_efficiency_range_b']) !!}
                                    <span class="input-group-addon" id="basic-addon2">[ Fraction ]</span>
                                 </div>
                              </div>
                           </div>
