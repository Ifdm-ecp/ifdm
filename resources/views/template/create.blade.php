...
<div class="nav">
   <div class="tabbable">
      ...
      <div class="tab-content">
         ...
         <div class="tab-pane active" id="reservoir_data">
               ...
               <div class="panel-body">
                  <div id="petrophysic_pleg" class="panel-collapse collapse in">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <fieldset>
                              <legend>Changes Along The Radius @if($advisor === "true")<span><i class="glyphicon glyphicon-info-sign show-table-advisor" id="code_table_excel_changes_along_the_radius_input" style="color:black;font-size:15pt;"></i></span>@endif </legend>
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  <h4><a data-parent="#accordion" data-toggle="collapse" href="#skin_characterization_pleg"><span class="chevron_toggleable glyphicon glyphicon-chevron-down pull-right"></span></a> Skin Characterization</h4>
               </div>
               <div class="panel-body">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('skin_characterization_non_darcy') ? 'has-error' : ''}}">
                                    ...
                                    @endif
                                    {!! Form::text('skin_characterization_non_darcy',null, ['placeholder' => 'Non Daray', 'class' =>'form-control', 'id' => 'skin_characterization_non_darcy']) !!}
                                    <span class="input-group-addon" id="basic-addon2">[ % ]</span>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('asphaltene_apparent_density') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('asphaltene_apparent_density',null, ['placeholder' => 'Asphaltene Apparent Density', 'class' =>'form-control', 'id' => 'asphaltene_apparent_density']) !!}
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="input-group {{$errors->has('asphaltene_dilution_capacity') ? 'has-error' : ''}}">
                                    ...
                                    <span class="input-group-addon" id="basic-addon2">[ mgAsph/LChem ]</span>
                                 </div>
                              </div>
                           </div>
                        </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <p class="pull-right">
            <input type="button" class="btn btn-primary" name="run" id="run" value="Save">
