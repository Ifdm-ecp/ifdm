...
<div id="sticky">
   <center>
      {!! Form::label('Scenario: ') !!} {!! $escenario->nombre !!} {!! Form::label(' - Basin: ') !!} {!! $basin->nombre !!} {!! Form::label(' - Field: ') !!} {!! $campo->nombre !!} {!! Form::label(' - Producing interval: ') !!} {!!  $intervalo->nombre !!} {!! Form::label(' - Well: ') !!} {!! $pozo->nombre !!} {!! Form::label(' - User: ') !!} {!! $user->fullName !!}
   </center>
</div>
</br>
   ...
   <div class="tabbable">
      ...
      <div class="tab-content">
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div id="prop_reservoir_pleg" class="panel-collapse collapse in">
                     {!!Form::open(array('id' => 'form_fines_remediation', 'url' => url('finesremediation/update',$fines->id), 'method' => 'post'))!!}
                     <input type="hidden" name="id_scenary" id="id_scenary" value="{{ !empty($duplicateFrom) ? $duplicateFrom : $escenario->id }}">
                     <div class="row">
                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('initial_porosity') ? 'has-error' : ''}}">
                                 ...
                                 <span class="input-group-btn">
                                    <button type="button" class="btn btn-default button-"><span class="glyphicon glyphicon-info-sign"></span></button>
                                 </span>
                                 @endif
                                 {!! Form::text('initial_porosity',$fines->initial_porosity, ['placeholder' => 'Initial Porosity', 'class' =>'form-control', 'id' => 'initial_porosity']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('initial_permeability') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('initial_permeability',$fines->initial_permeability, ['placeholder' => 'Initial Permeability', 'class' =>'form-control', 'id' => 'initial_permeability']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('temperature') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('temperature',$fines->temperature, ['placeholder' => 'Temperature', 'class' =>'form-control', 'id' => 'temperature']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('well_radius') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('well_radius',$fines->well_radius, ['placeholder' => 'Well Radius', 'class' =>'form-control', 'id' => 'well_radius']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('damage_radius') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('damage_radius',$fines->damage_radius, ['placeholder' => 'Damage Radius', 'class' =>'form-control', 'id' => 'damage_radius']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('net_pay') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('net_pay',$fines->net_pay, ['placeholder' => 'Net Pay', 'class' =>'form-control', 'id' => 'net_pay']) !!}
                                 <span class="input-group-addon" id="basic-addon2">[ ft ]</span>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('rock_compressibility') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('rock_compressibility',$fines->rock_compressibility, ['placeholder' => 'Rock Compressibility', 'class' =>'form-control', 'id' => 'rock_compressibility']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('pressure') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('pressure',$fines->pressure, ['placeholder' => 'Pressure', 'class' =>'form-control', 'id' => 'pressure']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('acid_concentration') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('acid_concentration',$fines->acid_concentration, ['placeholder' => 'Acid Concentration', 'class' =>'form-control', 'id' => 'acid_concentration']) !!}
                                 <span class="input-group-addon" id="basic-addon2">[ % ]</span>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('injection_rate') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('injection_rate',$fines->injection_rate, ['placeholder' => 'Injection Rate', 'class' =>'form-control', 'id' => 'injection_rate']) !!}
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('invasion_radius') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('invasion_radius',$fines->invasion_radius, ['placeholder' => 'Invasion Radius', 'class' =>'form-control', 'id' => 'invasion_radius']) !!}
                                 <span class="input-group-addon" id="basic-addon2">[ ft ]</span>
                              </div>
                           </div>
                        </div>
                        ...
                        {{-- <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('viscosity') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('viscosity',$fines->viscosity, ['placeholder' => 'Viscosity', 'class' =>'form-control', 'id' => 'viscosity']) !!}
         ...
         <div class="tab-pane" id="minerals_data">
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  <h4><a data-parent="#accordion" data-toggle="collapse" href="#choose_minerals_pleg"><span class="chevron_toggleable glyphicon glyphicon-chevron-down pull-right"></span></a> Choose Minerals @if($advisor === "true")<span><i class="glyphicon glyphicon-info-sign show-only-advisor" id="code_choose_minerals" style="color:black;font-size:15pt;"></i></span>@endif </h4>
               </div>
               <div class="panel-body">
