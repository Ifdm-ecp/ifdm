...
<div id="sticky">
   <center>
      {!! Form::label('Scenario: ') !!} {!! $escenario->nombre !!} 
      {!! Form::label(' - Basin: ') !!} {!! $cuenca->nombre !!} 
      {!! Form::label(' - Field: ') !!} {!! $campo->nombre!!} 
      {!! Form::label(' - Well: ') !!} {!!  $pozo->nombre !!} 
      {!! Form::label(' - User: ') !!} {!! $user->fullName !!}
   </center>
</div>
<p></p>
</br>
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div id="Prod" class="panel-collapse collapse in">
                     {{-- {!!Form::open(array('id' => 'form_scenario', 'url' => 'IPR2/store', 'method' => 'post'))!!} --}}
                     {!!Form::open(array('id' => 'form_scenario', 'url' => 'IPR/store/'.$escenario->id, 'method' => 'post'))!!}
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('fluido') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 <select name="well_type" onchange="defineWellType(this)" style="border-radius: 4px;" class="form-control" id="well_type">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('fluido') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 <select name="fluido" onchange="defineView(this,$('#well_type').val())" style="border-radius: 4px;" class="form-control" id="fluido">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group {{$errors->has('radio_pozo') ? 'has-error' : ''}}">
                                 ...
                                 @endif
                                 {!! Form::text('radio_pozo',$pozo->radius, ['placeholder' => 'Well Radius', 'class' =>'form-control', 'id' => 'radio_pozo']) !!}
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group data_third_input_rock">
                                       ...
                                       <div class="input-group">
                                          ...
                                          @endif
                                          {!! Form::text('',$form->netpay, ['placeholder' => '', 'class' =>'form-control', 'id' => '']) !!}
                                          <span class="input-group-addon" name="medida"></span>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group {{$errors->has('presion_yacimiento') ? 'has-error' : ''}}">
                                          ...
                                          @endif
                                          {!! Form::text('presion_yacimiento[]',$form->presion_reservorio, ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_yacimiento']) !!}
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group data_fourth_input_rock">
                                       ...
                                       <div class="input-group">
                                          ...
                                          @endif
                                          {!! Form::text('',$form->permeabilidad, ['placeholder' => '', 'class' =>'form-control', 'id' => '']) !!}
                                          <span class="input-group-addon" name="medida"></span>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group presion_separacion_div">
                                       ...
                                       <div class="input-group {{$errors->has('presion_separacion') ? 'has-error' : ''}}">
                                          ...
                                          @endif
                                          {!! Form::text('presion_separacion[]','', ['placeholder' => 'psi', 'class' =>'form-control', 'id' => 'presion_separacion']) !!}
                                          <span class="input-group-addon" id="basic-addon2">psi</span>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <input type='hidden' id='formation' name='formation' value="{{ $escenario->formacion_id }}">
...
<div class="row">
   <div class="col-md-12">
      <p class="pull-right">
         ...
         <input type="button" class="btn btn-success" onclick="enviar(true,2);" name="btn_os" id="btn_os" value="Save">
