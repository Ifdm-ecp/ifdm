...
Cache component extracted from the Doctrine Common project. [Documentation](https://doctrine-orm.readthedocs.io/projects/doctrine-orm/en/latest/reference/caching.html)
