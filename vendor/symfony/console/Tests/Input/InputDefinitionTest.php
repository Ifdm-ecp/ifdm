...
class InputDefinitionTest extends TestCase
{
    ...
    public function testLegacyAsText()
    {
        $definition = new InputDefinition(array(
            ...
            new InputArgument('bar', InputArgument::OPTIONAL | InputArgument::IS_ARRAY, 'The bar argument', array('https://foo.com/')),
            ...
            new InputOption('qux', '', InputOption::VALUE_OPTIONAL | InputOption::VALUE_IS_ARRAY, 'The qux option', array('https://foo.com/', 'bar')),
